import { a as te, g as oe } from "./index-DexSeZ02.js";
import { g as ne, d as re, a as ue } from "./index-DIjlsIS2.js";
import { u as se } from "./vue-router-DZ3MrWk1.js";
import { t as k } from "./dateUtil-BAIp0Nbc.js";
import { u as de } from "./index-DQDgIJ2e.js";
import { u as ie } from "./vue-clipboard3-xH3hfcUF.js";
import { _ as me } from "./index-DcnnzvoP.js";
import { a as pe, E as D } from "./element-plus-BOJqSAUc.js";
import { r as f, b as ce, X as ve, c as E, a as g, Q as l, I as a, ag as s, P as B, o as I, M as c, a6 as fe, H as ge, O as w, u as _e } from "./@vue-CnBZ4jx_.js";
...
const ye = { class: "log-main-container" }, be = { class: "search-area" }, Ve = { class: "pagination-div" }, Ne = { __name: "LogMain", setup(we) {
  const O = de(), S = se(), C = f(0), _ = f([]), V = f(), b = f([]), r = f({ pageNum: 1, pageSize: 10, serviceName: "", traceId: "", keyword: "", keywordNotIncluded: "", severityText: "", startTimestamp: 0, endTimestamp: 0 }), N = async () => {
...
`), L.value = true;
    ...
    try {
      ...
      o.close(), _.value.splice(0, _.value.length), S.go(0);
    }
...
`;
    ...
    const o = T(_.value), e = new Blob([o], { type: "text/plain;charset=utf-8" }), n = URL.createObjectURL(e), v = document.createElement("a");
