...
import { _ as l } from "./index-BwJ3HXHG.js";
...
const d = { class: "notify-404-container" }, f = { __name: "404", setup(x) {
  ...
  return (b, t) => {
    const s = e("el-button"), a = e("el-card");
    return _(), c("div", d, [o(a, null, { default: r(() => [t[1] || (t[1] = p("h1", null, "\u54E6\u543C 404", -1)), t[2] || (t[2] = p("p", null, "\u60A8\u8BBF\u95EE\u7684\u9875\u9762\u4E0D\u5B58\u5728,\u70B9\u51FB\u4E0B\u65B9\u6309\u94AE\u8DF3\u8F6C\u56DE\u5230\u4E3B\u9875\u3002", -1)), o(s, { type: "primary", onClick: n }, { default: r(() => t[0] || (t[0] = [u(" \u8FD4\u56DE\u4E3B\u9875 ")])), _: 1 })]), _: 1 })]);
  };
} }, z = l(f, [["__scopeId", "data-v-a6cdd1bc"]]);
export {
  z as default
};
