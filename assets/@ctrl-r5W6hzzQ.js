...
function W(r) {
  var t = { r: 0, g: 0, b: 0 }, e = 1, a = null, n = null, i = null, f = false, s = false;
  return typeof r == "string" && (r = U(r)), typeof r == "object" && (g(r.r) && g(r.g) && g(r.b) ? (t = E(r.r, r.g, r.b), f = true, s = String(r.r).substr(-1) === "%" ? "prgb" : "rgb") : g(r.h) && g(r.s) && g(r.v) ? (a = p(r.s), n = p(r.v), t = N(r.h, a, n), f = true, s = "hsv") : g(r.h) && g(r.s) && g(r.l) && (a = p(r.s), i = p(r.l), t = B(r.h, a, i), f = true, s = "hsl"), Object.prototype.hasOwnProperty.call(r, "a") && (e = r.a)), e = A(e), { ok: f, format: r.format || s, r: Math.min(255, Math.max(t.r, 0)), g: Math.min(255, Math.max(t.g, 0)), b: Math.min(255, Math.max(t.b, 0)), a: e };
}
var G = "[-\\+]?\\d+%?", q = "[-\\+]?\\d*\\.\\d+%?", d = "(?:".concat(q, ")|(?:").concat(G, ")"), y = "[\\s|\\(]+(".concat(d, ")[,|\\s]+(").concat(d, ")[,|\\s]+(").concat(d, ")\\s*\\)?"), m = "[\\s|\\(]+(".concat(d, ")[,|\\s]+(").concat(d, ")[,|\\s]+(").concat(d, ")[,|\\s]+(").concat(d, ")\\s*\\)?"), c = { CSS_UNIT: new RegExp(d), rgb: new RegExp("rgb" + y), rgba: new RegExp("rgba" + m), hsl: new RegExp("hsl" + y), hsla: new RegExp("hsla" + m), hsv: new RegExp("hsv" + y), hsva: new RegExp("hsva" + m), hex3: /^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, hex6: /^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/, hex4: /^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, hex8: /^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/ };
function U(r) {
  if (r = r.trim().toLowerCase(), r.length === 0) return false;
  var t = false;
  if (x[r]) r = x[r], t = true;
  else if (r === "transparent") return { r: 0, g: 0, b: 0, a: 0, format: "name" };
  var e = c.rgb.exec(r);
  return e ? { r: e[1], g: e[2], b: e[3] } : (e = c.rgba.exec(r), e ? { r: e[1], g: e[2], b: e[3], a: e[4] } : (e = c.hsl.exec(r), e ? { h: e[1], s: e[2], l: e[3] } : (e = c.hsla.exec(r), e ? { h: e[1], s: e[2], l: e[3], a: e[4] } : (e = c.hsv.exec(r), e ? { h: e[1], s: e[2], v: e[3] } : (e = c.hsva.exec(r), e ? { h: e[1], s: e[2], v: e[3], a: e[4] } : (e = c.hex8.exec(r), e ? { r: o(e[1]), g: o(e[2]), b: o(e[3]), a: w(e[4]), format: t ? "name" : "hex8" } : (e = c.hex6.exec(r), e ? { r: o(e[1]), g: o(e[2]), b: o(e[3]), format: t ? "name" : "hex" } : (e = c.hex4.exec(r), e ? { r: o(e[1] + e[1]), g: o(e[2] + e[2]), b: o(e[3] + e[3]), a: w(e[4] + e[4]), format: t ? "name" : "hex8" } : (e = c.hex3.exec(r), e ? { r: o(e[1] + e[1]), g: o(e[2] + e[2]), b: o(e[3] + e[3]), format: t ? "name" : "hex" } : false)))))))));
}
function g(r) {
...
var D = function() {
  ...
  return r.prototype.isDark = function() {
    ...
    return t === void 0 && (t = false), k(this.r, this.g, this.b, t);
  }, r.prototype.toHexString = function(t) {
    return t === void 0 && (t = false), "#" + this.toHex(t);
  }, r.prototype.toHex8 = function(t) {
    return t === void 0 && (t = false), P(this.r, this.g, this.b, this.a, t);
    ...
    for (var t = "#" + k(this.r, this.g, this.b, false), e = 0, a = Object.entries(x); e < a.length; e++) {
    ...
    var e = !!t;
    t = t ?? this.format;
    var a = false, n = this.a < 1 && this.a >= 0, i = !e && n && (t.startsWith("hex") || t === "name");
    return i ? t === "name" && this.a === 0 ? this.toName() : this.toRgbString() : (t === "rgb" && (a = this.toRgbString()), t === "prgb" && (a = this.toPercentageRgbString()), (t === "hex" || t === "hex6") && (a = this.toHexString()), t === "hex3" && (a = this.toHexString(true)), t === "hex4" && (a = this.toHex8String(true)), t === "hex8" && (a = this.toHex8String()), t === "name" && (a = this.toName()), t === "hsl" && (a = this.toHslString()), t === "hsv" && (a = this.toHsvString()), a || this.toHexString());
    ...
    e === void 0 && (e = 50);
    var a = this.toRgb(), n = new r(t).toRgb(), i = e / 100, f = { r: (n.r - a.r) * i + a.r, g: (n.g - a.g) * i + a.g, b: (n.b - a.b) * i + a.b, a: (n.a - a.a) * i + a.a };
    return new r(f);
    ...
    t === void 0 && (t = 6);
    for (var e = this.toHsv(), a = e.h, n = e.s, i = e.v, f = [], s = 1 / t; t--; ) f.push(new r({ h: a, s: n, v: i })), i = (i + s) % 1;
    return f;
    ...
    return new r({ r: (e.r * e.a + a.r * a.a * (1 - e.a)) / n, g: (e.g * e.a + a.g * a.a * (1 - e.a)) / n, b: (e.b * e.a + a.b * a.a * (1 - e.a)) / n, a: n });
  }, r.prototype.triad = function() {
    return this.polyad(3);
  }, r.prototype.tetrad = function() {
    return this.polyad(4);
  }, r.prototype.polyad = function(t) {
    for (var e = this.toHsl(), a = e.h, n = [this], i = 360 / t, f = 1; f < t; f++) n.push(new r({ h: (a + f * i) % 360, s: e.s, l: e.l }));
    return n;
