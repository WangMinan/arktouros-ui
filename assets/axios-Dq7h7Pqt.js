...
const { toString: Qe } = Object.prototype, { getPrototypeOf: le } = Object, { iterator: K, toStringTag: Ce } = Symbol, v = /* @__PURE__ */ ((e) => (t) => {
  const n = Qe.call(t);
...
const et = X("string"), A = X("function"), Pe = X("number"), G = (e) => e !== null && typeof e == "object", tt = (e) => e === true || e === false, z = (e) => {
  ...
  let t;
  return e && (typeof FormData == "function" && e instanceof FormData || A(e.append) && ((t = v(e)) === "formdata" || t === "object" && A(e.toString) && e.toString() === "[object FormData]"));
...
const ht = (e, t, n, { allOwnKeys: r } = {}) => (H(t, (s, o) => {
  ...
  for (; t-- > 0; ) n[t] = e[t];
  return n;
}, Rt = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && le(Uint8Array)), St = (e, t) => {
  ...
  return r;
}, Ot = C("HTMLFormElement"), Tt = (e) => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function(n, r, s) {
...
Object.defineProperty(Be, "isAxiosError", { value: true });
m.from = (e, t, n, r, s, o) => {
...
function Q(e, t, n) {
  ...
  function u(d, y, h) {
    ...
    if (d && !h && typeof d == "object") {
      if (a.endsWith(y, "{}")) y = r ? y : y.slice(0, -2), d = JSON.stringify(d);
      else if (a.isArray(d) && jt(d) || (a.isFileList(d) || a.endsWith(y, "[]")) && (w = a.toArray(d))) return y = ke(y), w.forEach(function(g, P) {
        !(a.isUndefined(g) || g === null) && t.append(i === true ? he([y], P, o) : i === null ? y : y + "[]", l(g));
      }), false;
    }
    return se(d) ? true : (t.append(he(h, y, o), l(d)), false);
  }
  const p = [], b = Object.assign(qt, { defaultVisitor: u, convertValue: l, isVisitable: se });
  function R(d, y) {
    if (!a.isUndefined(d)) {
...
const He = { silentJSONParsing: true, forcedJSONParsing: true, clarifyTimeoutError: false }, It = typeof URLSearchParams < "u" ? URLSearchParams : ue, Mt = typeof FormData < "u" ? FormData : null, zt = typeof Blob < "u" ? Blob : null, $t = { isBrowser: true, classes: { URLSearchParams: It, FormData: Mt, Blob: zt }, protocols: ["http", "https", "file", "blob", "url", "data"] }, fe = typeof window < "u" && typeof document < "u", oe = typeof navigator == "object" && navigator || void 0, Jt = fe && (!oe || ["ReactNative", "NativeScript", "NS"].indexOf(oe.product) < 0), Vt = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Wt = fe && window.location.href || "http://localhost", Kt = Object.freeze(Object.defineProperty({ __proto__: null, hasBrowserEnv: fe, hasStandardBrowserEnv: Jt, hasStandardBrowserWebWorkerEnv: Vt, navigator: oe, origin: Wt }, Symbol.toStringTag, { value: "Module" })), O = { ...Kt, ...$t };
function vt(e, t) {
  return Q(e, new O.classes.URLSearchParams(), Object.assign({ visitor: function(n, r, s, o) {
...
const I = { transitional: He, adapter: ["xhr", "http", "fetch"], transformRequest: [function(t, n) {
  const r = n.getContentType() || "", s = r.indexOf("application/json") > -1, o = a.isObject(t);
  if (o && a.isHTMLForm(t) && (t = new FormData(t)), a.isFormData(t)) return s ? JSON.stringify(Ie(t)) : t;
  ...
  return o || s ? (n.setContentType("application/json", false), Qt(t)) : t;
...
const Zt = a.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]), Yt = (e) => {
  const t = {};
  let n, r, s;
  return e && e.split(`
`).forEach(function(i) {
...
let x = class {
  ...
  set(t, n, r) {
    ...
    function o(c, f, l) {
      ...
      (!p || s[p] === void 0 || l === true || l === void 0 && s[p] !== false) && (s[p || f] = $(c));
    }
    const i = (c, f) => a.forEach(c, (l, u) => o(l, u, f));
    if (a.isPlainObject(t) || t instanceof this.constructor) i(t, n);
    else if (a.isString(t) && (t = t.trim()) && !tn(t)) i(Yt(t), n);
...
`);
  ...
  static accessor(t) {
    const r = (this[be] = this[be] = { accessors: {} }).accessors, s = this.prototype;
    function o(i) {
      const c = j(i);
      r[c] || (rn(s, i), r[c] = true);
    }
...
const V = (e, t, n = 3) => {
  ...
  return an((o) => {
    ...
    r = i;
    const p = { loaded: i, total: c, progress: c ? i / c : void 0, bytes: f, rate: l || void 0, estimated: l && c && u ? (c - i) / l : void 0, event: o, lengthComputable: c != null, [t ? "download" : "upload"]: true };
    e(p);
  }, n);
}, we = (e, t) => {
  const n = e != null;
  return [(r) => t[0]({ lengthComputable: n, total: e, loaded: r }), t[1]];
}, Ee = (e) => (...t) => a.asap(() => e(...t)), cn = O.hasStandardBrowserEnv ? /* @__PURE__ */ ((e, t) => (n) => (n = new URL(n, O.origin), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(new URL(O.origin), O.navigator && /(msie|trident)/i.test(O.navigator.userAgent)) : () => true, ln = O.hasStandardBrowserEnv ? { write(e, t, n, r, s, o) {
...
function B(e, t) {
  ...
  function s(l, u, p, b) {
    if (a.isUndefined(u)) {
      if (!a.isUndefined(l)) return r(void 0, l, p, b);
...
const Je = (e) => {
  ...
  t.headers = i = x.from(i), t.url = qe($e(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer), c && i.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : "")));
  let f;
  if (a.isFormData(n)) {
  ...
  if (O.hasStandardBrowserEnv && (r && a.isFunction(r) && (r = r(t)), r || r !== false && cn(t.url))) {
  ...
  return new Promise(function(n, r) {
    ...
    function w() {
      if (!h) return;
      const g = x.from("getAllResponseHeaders" in h && h.getAllResponseHeaders()), T = { data: !c || c === "text" || c === "json" ? h.responseText : h.response, status: h.status, statusText: h.statusText, headers: g, config: e, request: h };
      ze(function(_) {
        n(_), y();
      }, function(_) {
        r(_), y();
    ...
    }), a.isUndefined(s.withCredentials) || (h.withCredentials = !!s.withCredentials), c && c !== "json" && (h.responseType = s.responseType), l && ([b, d] = V(l, true), h.addEventListener("progress", b)), f && h.upload && ([p, R] = V(f), h.upload.addEventListener("progress", p), h.upload.addEventListener("loadend", R)), (s.cancelToken || s.signal) && (u = (g) => {
...
}, Z = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Ve = Z && typeof ReadableStream == "function", wn = Z && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), We = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return false;
  ...
  return e && !t;
}), ge = 64 * 1024, ie = Ve && We(() => a.isReadableStream(new Response("").body)), W = { stream: ie && ((e) => e.body) };
Z && ((e) => {
...
const Rn = async (e) => {
  ...
  let { url: t, method: n, data: r, signal: s, cancelToken: o, timeout: i, onDownloadProgress: c, onUploadProgress: f, responseType: l, headers: u, withCredentials: p = "same-origin", fetchOptions: b } = Je(e);
  ...
  try {
    if (f && En && n !== "get" && n !== "head" && (h = await Sn(u, r)) !== 0) {
      ...
      if (a.isFormData(r) && (F = T.headers.get("content-type")) && u.setContentType(F), T.body) {
        const [_, M] = we(h, V(Ee(f)));
        r = Se(T.body, ge, _, M);
      }
    }
    a.isString(p) || (p = p ? "include" : "omit");
    const w = "credentials" in Request.prototype;
    d = new Request(t, { ...b, signal: R, method: n.toUpperCase(), headers: u.normalize().toJSON(), body: r, duplex: "half", credentials: w ? p : void 0 });
    ...
    if (ie && (c || g && y)) {
      ...
      const F = a.toFiniteNumber(S.headers.get("content-length")), [_, M] = c && we(F, V(Ee(c), true)) || [];
      S = new Response(Se(S.body, ge, _, () => {
        M && M(), y && y();
      }), T);
    }
    l = l || "text";
    ...
    return !g && y && y(), await new Promise((T, F) => {
      ze(T, F, { data: P, headers: x.from(S.headers), status: S.status, statusText: S.statusText, config: e, request: d });
    });
  } catch (w) {
    throw y && y(), w && w.name === "TypeError" && /Load failed|fetch/i.test(w.message) ? Object.assign(new m("Network Error", m.ERR_NETWORK, e, d), { cause: w.cause || w }) : m.from(w, w && w.code, e, d);
  }
}), ae = { http: kt, xhr: pn, fetch: gn };
a.forEach(ae, (e, t) => {
  if (e) {
    try {
...
const Oe = (e) => `- ${e}`, On = (e) => a.isFunction(e) || e === null || e === false, Ke = { getAdapter: (e) => {
  e = a.isArray(e) ? e : [e];
  const { length: t } = e;
  let n, r;
  const s = {};
  for (let o = 0; o < t; o++) {
    n = e[o];
    let i;
    if (r = n, !On(n) && (r = ae[(i = String(n)).toLowerCase()], r === void 0)) throw new m(`Unknown adapter '${i}'`);
    if (r) break;
    s[i || "#" + o] = r;
  }
  if (!r) {
...
function Te(e) {
  return ne(e), e.headers = x.from(e.headers), e.data = te.call(e, e.transformRequest), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", false), Ke.getAdapter(e.adapter || I.adapter)(e).then(function(r) {
    return ne(e), r.data = te.call(e, e.transformResponse, r), r.headers = x.from(r.headers), r;
  }, function(r) {
    return Me(r) || (ne(e), r && r.response && (r.response.data = te.call(e, e.transformResponse, r.response), r.response.headers = x.from(r.response.headers))), Promise.reject(r);
  });
}
const ve = "1.10.0", Y = {};
...
Y.transitional = function(t, n, r) {
  ...
  return (o, i, c) => {
    ...
    return n && !Ae[i] && (Ae[i] = true, console.warn(s(i, " has been deprecated since v" + n + " and will be removed in the near future"))), t ? t(o, i, c) : true;
  };
};
...
const J = { assertOptions: Tn, validators: Y }, N = J.validators;
let L = class {
  constructor(t) {
...
let An = class Xe {
  ...
  static source() {
    let t;
    return { token: new Xe(function(s) {
      t = s;
    }), cancel: t };
  }
};
...
E.HttpStatusCode = ce;
E.default = E;
const { Axios: Fn, AxiosError: _n, CanceledError: Un, isCancel: Ln, CancelToken: Bn, VERSION: Dn, all: kn, Cancel: jn, isAxiosError: qn, spread: Hn, toFormData: In, AxiosHeaders: Mn, HttpStatusCode: zn, formToJSON: $n, getAdapter: Jn, mergeConfig: Vn } = E;
export {
  E as a
};
