...
var Hf = /* @__PURE__ */ function() {
  ...
  function r() {
    this.browser = new Hf(), this.node = false, this.wxa = false, this.worker = false, this.svgSupported = false, this.touchEventsSupported = false, this.pointerEventsSupported = false, this.domSupported = false, this.transformSupported = false, this.transform3dSupported = false, this.hasGlobalWindow = typeof window < "u";
  }
  return r;
}(), X = new zf();
typeof wx == "object" && typeof wx.getSystemInfoSync == "function" ? (X.wxa = true, X.touchEventsSupported = true) : typeof document > "u" && typeof self < "u" ? X.worker = true : !X.hasGlobalWindow || "Deno" in window ? (X.node = true, X.svgSupported = true) : Nf(navigator.userAgent, X);
function Nf(r, t) {
...
var sn = 12, lo = "sans-serif", Qt = sn + "px " + lo, Yf = 20, Gf = 100, Xf = "007LLmW'55;N0500LLLLLLLLLL00NNNLzWW\\\\WQb\\0FWLg\\bWb\\WQ\\WrWWQ000CL5LLFLL0LL**F*gLLLL5F0LF\\FFF5.5N";
function Uf(r) {
  var t = {};
  if (typeof JSON > "u") return t;
  for (var e = 0; e < r.length; e++) {
    var i = String.fromCharCode(e + 32), a = (r.charCodeAt(e) - Yf) / Gf;
    t[i] = a;
  }
  return t;
}
var Wf = Uf(Xf), Mi = { createCanvas: function() {
  return typeof document < "u" && document.createElement("canvas");
}, measureText: /* @__PURE__ */ function() {
  var r, t;
  return function(e, i) {
    if (!r) {
      var a = Mi.createCanvas();
      r = a && a.getContext("2d");
    }
    if (r) return t !== i && (t = r.font = i || Qt), r.measureText(e);
    e = e || "", i = i || Qt;
    var n = /((?:\d+)?\.?\d*)px/.exec(i), s = n && +n[1] || sn, o = 0;
...
} }, co = Li(["Function", "RegExp", "Date", "Error", "CanvasGradient", "CanvasPattern", "Image", "Canvas"], function(r, t) {
  return r["[object " + t + "]"] = true, r;
}, {}), po = Li(["Int8", "Uint8", "Uint8Clamped", "Int16", "Uint16", "Int32", "Uint32", "Float32", "Float64"], function(r, t) {
  return r["[object " + t + "Array]"] = true, r;
}, {}), Qr = Object.prototype.toString, Pi = Array.prototype, qf = Pi.forEach, $f = Pi.filter, on = Pi.slice, Vf = Pi.map, Ln = (function() {
}).constructor, Oe = Ln ? Ln.prototype : null, fn = "__proto__", Zf = 2311;
function go() {
  return Zf++;
}
function hn() {
...
function Pr(r) {
  ...
  } else if (!co[e] && !pe(r) && !La(r)) {
    t = {};
    for (var s in r) r.hasOwnProperty(s) && s !== fn && (t[s] = Pr(r[s]));
  }
  return t;
}
function Hr(r, t, e) {
  if (!Xt(t) || !Xt(r)) return e ? Pr(t) : r;
  for (var i in t) if (t.hasOwnProperty(i) && i !== fn) {
    var a = r[i], n = t[i];
    Xt(n) && Xt(a) && !Zr(n) && !Zr(a) && !La(n) && !La(a) && !xn(n) && !xn(a) && !pe(n) && !pe(a) ? Hr(a, n, e) : (e || !(i in r)) && (r[i] = Pr(t[i]));
  }
  return r;
}
function pc(r, t) {
  for (var e = r[0], i = 1, a = r.length; i < a; i++) e = Hr(e, r[i], t);
  return e;
}
function z(r, t) {
  if (Object.assign) Object.assign(r, t);
  else for (var e in t) t.hasOwnProperty(e) && e !== fn && (r[e] = t[e]);
  return r;
}
function Tt(r, t, e) {
...
function nt(r, t, e) {
  if (r && t) if (r.forEach && r.forEach === qf) r.forEach(t, e);
...
function Z(r, t, e) {
  if (!r) return [];
  if (!t) return yo(r);
  if (r.map && r.map === Vf) return r.map(t, e);
...
function Pa(r, t, e) {
  if (!r) return [];
  if (!t) return yo(r);
  if (r.filter && r.filter === $f) return r.filter(t, e);
...
function Kf(r, t) {
  ...
  return function() {
    return r.apply(t, e.concat(on.call(arguments)));
  };
}
var yc = Oe && Re(Oe.bind) ? Oe.call.bind(Oe.bind) : Kf;
function mc(r) {
  for (var t = [], e = 1; e < arguments.length; e++) t[e - 1] = arguments[e];
  return function() {
    return r.apply(this, t.concat(on.call(arguments)));
  };
}
function Zr(r) {
  return Array.isArray ? Array.isArray(r) : Qr.call(r) === "[object Array]";
}
function Re(r) {
...
function wc(r) {
  return Qr.call(r) === "[object String]";
}
function de(r) {
...
function Tc(r) {
  return Qr.call(r) === "[object RegExp]";
}
function jf(r) {
  return r !== r;
}
...
}(), wo = typeof Map == "function";
function eh() {
  return wo ? /* @__PURE__ */ new Map() : new rh();
}
var ih = function() {
  function r(t) {
    var e = Zr(t);
...
function Ra(r, t, e, i, a, n) {
  var s = i + "-" + a, o = r.length;
  if (n.hasOwnProperty(s)) return n[s];
  if (t === 1) {
    var f = Math.round(Math.log((1 << o) - 1 & ~a) / ch);
    return r[e][f];
  }
  for (var h = i | 1 << e, u = e + 1; i & 1 << u; ) u++;
  for (var v = 0, l = 0, c = 0; l < o; l++) {
    var p = 1 << l;
    p & a || (v += (c % 2 ? -1 : 1) * r[e][l] * Ra(r, t - 1, u, h, a | p, n), c++);
  }
  return n[s] = v, v;
}
function Dn(r, t) {
  var e = [[r[0], r[1], 1, 0, 0, 0, -t[0] * r[0], -t[0] * r[1]], [0, 0, 0, r[0], r[1], 1, -t[1] * r[0], -t[1] * r[1]], [r[2], r[3], 1, 0, 0, 0, -t[2] * r[2], -t[2] * r[3]], [0, 0, 0, r[2], r[3], 1, -t[3] * r[2], -t[3] * r[3]], [r[4], r[5], 1, 0, 0, 0, -t[4] * r[4], -t[4] * r[5]], [0, 0, 0, r[4], r[5], 1, -t[5] * r[4], -t[5] * r[5]], [r[6], r[7], 1, 0, 0, 0, -t[6] * r[6], -t[6] * r[7]], [0, 0, 0, r[6], r[7], 1, -t[7] * r[6], -t[7] * r[7]]], i = {}, a = Ra(e, 8, 0, 0, 0, i);
  if (a !== 0) {
    for (var n = [], s = 0; s < 8; s++) for (var o = 0; o < 8; o++) n[o] == null && (n[o] = 0), n[o] += ((s + o) % 2 ? -1 : 1) * Ra(e, 7, s === 0 ? 1 : 0, 1 << s, 1 << o, i) / a * t[s];
...
var In = "___zrEVENTSAVED", Ni = [];
function Rc(r, t, e, i, a) {
  return Aa(Ni, t, i, a, true) && Aa(r, e, Ni[0], Ni[1]);
}
function Aa(r, t, e, i, a) {
  if (t.getBoundingClientRect && X.domSupported && !bo(t)) {
    var n = t[In] || (t[In] = {}), s = dh(t, n), o = ph(s, n, a);
...
function ph(r, t, e) {
  ...
  return f && a ? a : (t.srcCoords = s, t[i] = e ? Dn(o, s) : Dn(s, o));
}
function bo(r) {
...
var gh = /([&<>"'])/g, _h = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
function yh(r) {
  return r == null ? "" : (r + "").replace(gh, function(t, e) {
    return _h[e];
  });
}
var mh = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Yi = [], wh = X.browser.firefox && +X.browser.version.split(".")[0] < 39;
function Da(r, t, e, i) {
  return e = e || {}, i ? En(r, t, e) : wh && t.layerX != null && t.layerX !== t.offsetX ? (e.zrX = t.layerX, e.zrY = t.layerY) : t.offsetX != null ? (e.zrX = t.offsetX, e.zrY = t.offsetY) : En(r, t, e), e;
}
function En(r, t, e) {
...
function St(r, t, e) {
  ...
  var o = t.button;
  return t.which == null && o !== void 0 && mh.test(t.type) && (t.which = o & 1 ? 1 : o & 2 ? 3 : o & 4 ? 2 : 0), t;
}
function Th(r) {
  var t = r.wheelDelta;
  if (t) return t;
...
var Mh = function() {
  ...
  return r.prototype.recognize = function(t, e, i) {
    ...
    for (var e in Gi) if (Gi.hasOwnProperty(e)) {
      var i = Gi[e](this._track, t);
      if (i) return i;
    }
  }, r;
}();
...
}(), ke = Math.min, Be = Math.max, tr = new k(), rr = new k(), er = new k(), ir = new k(), re = new k(), ee = new k(), U = function() {
  function r(t, e, i, a) {
    i < 0 && (t = t + i, i = -i), a < 0 && (e = e + a, a = -a), this.x = t, this.y = e, this.width = i, this.height = a;
  }
  return r.prototype.union = function(t) {
    var e = ke(t.x, this.x), i = ke(t.y, this.y);
    isFinite(this.x) && isFinite(this.width) ? this.width = Be(t.x + t.width, this.x + this.width) - e : this.width = t.width, isFinite(this.y) && isFinite(this.height) ? this.height = Be(t.y + t.height, this.y + this.height) - i : this.height = t.height, this.x = e, this.y = i;
    ...
    return Ia(n, n, [-e.x, -e.y]), Mo(n, n, [i, a]), Ia(n, n, [t.x, t.y]), n;
    ...
    if (e) {
      ...
      n < f || h < a ? m > p && (p = m, _ < d ? k.set(ee, -_, 0) : k.set(ee, d, 0)) : m < c && (c = m, _ < d ? k.set(re, _, 0) : k.set(re, -d, 0)), o < u || v < s ? w > p && (p = w, g < y ? k.set(ee, 0, -g) : k.set(ee, 0, y)) : m < c && (c = m, g < y ? k.set(re, 0, g) : k.set(re, 0, -y));
    }
    return e && k.copy(e, l ? re : ee), l;
    ...
    tr.x = er.x = e.x, tr.y = ir.y = e.y, rr.x = ir.x = e.x + e.width, rr.y = er.y = e.y + e.height, tr.transform(i), ir.transform(i), rr.transform(i), er.transform(i), t.x = ke(tr.x, rr.x, er.x, ir.x), t.y = ke(tr.y, rr.y, er.y, ir.y);
    var f = Be(tr.x, rr.x, er.x, ir.x), h = Be(tr.y, rr.y, er.y, ir.y);
    t.width = f - t.x, t.height = h - t.y;
  }, r;
}(), Po = "silent";
function Rh(r, t, e) {
  return { type: r, event: e, target: t.target, topTarget: t.topTarget, cancelBubble: false, offsetX: e.zrX, offsetY: e.zrY, gestureEvent: e.gestureEvent, pinchX: e.pinchX, pinchY: e.pinchY, pinchScale: e.pinchScale, wheelDelta: e.zrDelta, zrByTouch: e.zrByTouch, which: e.which, stop: Ah };
}
function Ah() {
  Ch(this.event);
}
...
}(jr), ie = /* @__PURE__ */ function() {
  function r(t, e) {
    this.x = t, this.y = e;
  }
  return r;
}(), Ih = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"], Xi = new U(0, 0, 0, 0), Lo = function(r) {
  N(t, r);
  function t(e, i, a, n, s) {
    var o = r.call(this) || this;
    return o._hovered = new ie(0, 0), o.storage = e, o.painter = i, o.painterRoot = n, o._pointerSize = s, a = a || new Dh(), o.proxy = null, o.setHandlerProxy(a), o._draggingMgr = new lh(o), o;
  }
  return t.prototype.setHandlerProxy = function(e) {
    this.proxy && this.proxy.dispose(), e && (nt(Ih, function(i) {
      e.on && e.on(i, this[i], this);
    }, this), e.handler = this), this.proxy = e;
  }, t.prototype.mousemove = function(e) {
    var i = e.zrX, a = e.zrY, n = xo(this, i, a), s = this._hovered, o = s.target;
    o && !o.__zr && (s = this.findHover(s.x, s.y), o = s.target);
    var f = this._hovered = n ? new ie(i, a) : this.findHover(i, a), h = f.target, u = this.proxy;
    ...
    var n = e.target;
    if (!(n && n.silent)) {
      for (var s = "on" + i, o = Rh(i, e, a); n && (n[s] && (o.cancelBubble = !!n[s].call(n, o)), n.trigger(i, o), n = n.__hostTarget ? n.__hostTarget : n.parent, !o.cancelBubble); ) ;
    ...
    var n = this.storage.getDisplayList(), s = new ie(e, i);
    if (On(n, s, e, i, a), this._pointerSize && !s.target) {
      for (var o = [], f = this._pointerSize, h = f / 2, u = new U(e - h, i - h, f, f), v = n.length - 1; v >= 0; v--) {
        var l = n[v];
        l !== a && !l.ignore && !l.ignoreCoarsePointer && (!l.parent || !l.parent.ignoreCoarsePointer) && (Xi.copy(l.getBoundingRect()), l.transform && Xi.applyTransform(l.transform), Xi.intersect(u) && o.push(l));
      }
      if (o.length) for (var c = 4, p = Math.PI / 12, _ = Math.PI * 2, d = 0; d < h; d += c) for (var g = 0; g < _; g += p) {
        var y = e + d * Math.cos(g), m = i + d * Math.sin(g);
        if (On(o, s, y, m, a), s.target) return s;
      }
    }
    return s;
  }, t.prototype.processGesture = function(e, i) {
    this._gestureMgr || (this._gestureMgr = new Mh());
...
nt(["click", "mousedown", "mouseup", "mousewheel", "dblclick", "contextmenu"], function(r) {
  Lo.prototype[r] = function(t) {
    var e = t.zrX, i = t.zrY, a = xo(this, e, i), n, s;
    if ((r !== "mouseup" || !a) && (n = this.findHover(e, i), s = n.target), r === "mousedown") this._downEl = s, this._downPoint = [t.zrX, t.zrY], this._upEl = s;
      ...
      if (this._downEl !== this._upEl || !this._downPoint || hh(this._downPoint, [t.zrX, t.zrY]) > 4) return;
...
function On(r, t, e, i, a) {
  for (var n = r.length - 1; n >= 0; n--) {
    var s = r[n], o = void 0;
    if (s !== a && !s.ignore && (o = Eh(s, e, i)) && (!t.topTarget && (t.topTarget = s), o !== Po)) {
      t.target = s;
      break;
    }
  }
...
function kh(r, t) {
  ...
  function u(c) {
    ...
    var y = Wi(r[d], r, p, _, 0, t);
    p += y, _ -= y, _ !== 0 && (g = Ui(r[p + _ - 1], r, d, g, g - 1, t), g !== 0 && (_ <= g ? v(p, _, d, g) : l(p, _, d, g)));
  }
  function v(c, p, _, d) {
    var g = 0;
...
var ct = 1, he = 2, Or = 4, Hn = false;
function qi() {
  Hn || (Hn = true, console.warn("z / z2 / zlevel of displayable is invalid, which may cause unexpected errors"));
}
function zn(r, t) {
...
var Hh = function() {
  function r() {
    this._roots = [], this._displayList = [], this._displayListLen = 0, this.displayableSortFunc = zn;
  }
  return r.prototype.traverse = function(t, e) {
    ...
    i.length = this._displayListLen, Bh(i, zn);
    ...
    if (!(t.ignore && !i)) {
      ...
      if (t.childrenRef) {
        ...
        var u = t;
        e && e.length ? u.__clipPaths = e : u.__clipPaths && u.__clipPaths.length > 0 && (u.__clipPaths = []), isNaN(u.z) && (qi(), u.z = 0), isNaN(u.z2) && (qi(), u.z2 = 0), isNaN(u.zlevel) && (qi(), u.zlevel = 0), this._displayList[this._displayListLen++] = u;
      }
...
var ye = { linear: function(r) {
  ...
  return 1 - ye.bounceOut(1 - r);
}, bounceOut: function(r) {
  return r < 1 / 2.75 ? 7.5625 * r * r : r < 2 / 2.75 ? 7.5625 * (r -= 1.5 / 2.75) * r + 0.75 : r < 2.5 / 2.75 ? 7.5625 * (r -= 2.25 / 2.75) * r + 0.9375 : 7.5625 * (r -= 2.625 / 2.75) * r + 0.984375;
}, bounceInOut: function(r) {
  return r < 0.5 ? ye.bounceIn(r * 2) * 0.5 : ye.bounceOut(r * 2 - 1) * 0.5 + 0.5;
} }, He = Math.pow, Kt = Math.sqrt, vi = 1e-8, Ao = 1e-4, Nn = Kt(3), ze = 1 / 3, Ft = Jr(), wt = Jr(), Vr = Jr();
function $t(r) {
  return r > -vi && r < vi;
}
function Do(r) {
...
function Yn(r, t, e, i, a) {
  var n = 1 - a;
  return 3 * (((t - r) * n + 2 * (e - t) * a) * n + (i - e) * a * a);
}
function Io(r, t, e, i, a, n) {
  ...
  if ($t(u) && $t(v)) if ($t(o)) n[0] = 0;
    ...
    if ($t(_)) {
      ...
      m < 0 ? m = -He(-m, ze) : m = He(m, ze), w < 0 ? w = -He(-w, ze) : w = He(w, ze);
      var p = (-o - (m + w)) / (3 * s);
      p >= 0 && p <= 1 && (n[c++] = p);
    } else {
      var S = (2 * u * o - 3 * s * v) / (2 * Kt(u * u * u)), b = Math.acos(S) / 3, T = Kt(u), C = Math.cos(b), p = (-o - 2 * T * C) / (3 * s), g = (-o + T * (C + Nn * Math.sin(b))) / (3 * s), M = (-o + T * (C - Nn * Math.sin(b))) / (3 * s);
      p >= 0 && p <= 1 && (n[c++] = p), g >= 0 && g <= 1 && (n[c++] = g), M >= 0 && M <= 1 && (n[c++] = M);
    }
  }
  return c;
}
function Eo(r, t, e, i, a) {
...
function zh(r, t, e, i, a, n, s, o, f, h, u) {
  var v, l = 5e-3, c = 1 / 0, p, _, d, g;
  Ft[0] = f, Ft[1] = h;
  for (var y = 0; y < 1; y += 0.05) wt[0] = rt(r, e, a, s, y), wt[1] = rt(t, i, n, o, y), d = $r(Ft, wt), d < c && (v = y, c = d);
  c = 1 / 0;
  for (var m = 0; m < 32 && !(l < Ao); m++) p = v - l, _ = v + l, wt[0] = rt(r, e, a, s, p), wt[1] = rt(t, i, n, o, p), d = $r(wt, Ft), p >= 0 && d < c ? (v = p, c = d) : (Vr[0] = rt(r, e, a, s, _), Vr[1] = rt(t, i, n, o, _), g = $r(Vr, Ft), _ <= 1 && g < c ? (v = _, c = g) : l *= 0.5);
...
function li(r, t, e, i, a) {
  var n = (t - r) * i + r, s = (e - t) * i + t, o = (s - n) * i + n;
  a[0] = r, a[1] = n, a[2] = o, a[3] = o, a[4] = s, a[5] = e;
}
function Gh(r, t, e, i, a, n, s, o, f) {
  var h, u = 5e-3, v = 1 / 0;
  Ft[0] = s, Ft[1] = o;
  for (var l = 0; l < 1; l += 0.05) {
    wt[0] = at(r, e, a, l), wt[1] = at(t, i, n, l);
    var c = $r(Ft, wt);
    c < v && (h = l, v = c);
  }
  v = 1 / 0;
  for (var p = 0; p < 32 && !(u < Ao); p++) {
    var _ = h - u, d = h + u;
    wt[0] = at(r, e, a, _), wt[1] = at(t, i, n, _);
    var c = $r(wt, Ft);
    if (_ >= 0 && c < v) h = _, v = c;
    else {
      Vr[0] = at(r, e, a, d), Vr[1] = at(t, i, n, d);
      var g = $r(Vr, Ft);
...
var Uh = /cubic-bezier\(([0-9,\.e ]+)\)/;
function vn(r) {
  var t = r && Uh.exec(r);
  if (t) {
    var e = t[1].split(","), i = +zr(e[0]), a = +zr(e[1]), n = +zr(e[2]), s = +zr(e[3]);
    if (isNaN(i + a + n + s)) return;
    var o = [];
    return function(f) {
      return f <= 0 ? 0 : f >= 1 ? 1 : Io(0, i, n, 1, f, o) && rt(0, a, s, 1, o[0]);
    };
  }
}
var Wh = function() {
  ...
  return r.prototype.step = function(t, e) {
    ...
    this.easing = t, this.easingFunc = Re(t) ? t : ye[t] || vn(t);
  }, r;
  ...
  return r.prototype.put = function(t, e) {
    ...
    if (a[t] == null) {
      ...
      o ? o.value = e : o = new Oo(e), o.key = t, i.insertEntry(o), a[t] = o;
    }
    return n;
  }, r.prototype.get = function(t) {
...
function Cr(r) {
  var t = r;
  return t.length && t.charAt(t.length - 1) === "%" ? Te(parseFloat(t) / 100) : Te(parseFloat(t));
}
function Vi(r, t, e) {
...
function yt(r, t, e, i, a) {
  return r[0] = t, r[1] = e, r[2] = i, r[3] = a, r;
}
function Ea(r, t) {
  return r[0] = t[0], r[1] = t[1], r[2] = t[2], r[3] = t[3], r;
}
var ko = new Ai(20), Ne = null;
function xr(r, t) {
  Ne && Ea(Ne, t), Ne = ko.put(r, Ne || t.slice());
}
function Pt(r, t) {
  if (r) {
    t = t || [];
    ...
    if (i in Xn) return Ea(t, Xn[i]), xr(r, t), t;
    var a = i.length;
    if (i.charAt(0) === "#") {
      if (a === 4 || a === 5) {
        ...
        return yt(t, (n & 3840) >> 4 | (n & 3840) >> 8, n & 240 | (n & 240) >> 4, n & 15 | (n & 15) << 4, a === 5 ? parseInt(i.slice(4), 16) / 15 : 1), xr(r, t), t;
      } else if (a === 7 || a === 9) {
        ...
        return yt(t, (n & 16711680) >> 16, (n & 65280) >> 8, n & 255, a === 9 ? parseInt(i.slice(7), 16) / 255 : 1), xr(r, t), t;
      }
      return;
    }
    ...
    if (s !== -1 && o + 1 === a) {
      ...
      switch (f) {
        case "rgba":
          if (h.length !== 4) return h.length === 3 ? yt(t, +h[0], +h[1], +h[2], 1) : yt(t, 0, 0, 0, 1);
          u = Cr(h.pop());
        case "rgb":
          if (h.length >= 3) return yt(t, $i(h[0]), $i(h[1]), $i(h[2]), h.length === 3 ? u : Cr(h[3])), xr(r, t), t;
          yt(t, 0, 0, 0, 1);
          return;
        case "hsla":
          if (h.length !== 4) {
          ...
          return h[3] = Cr(h[3]), Fa(h, t), xr(r, t), t;
        case "hsl":
          if (h.length !== 3) {
            yt(t, 0, 0, 0, 1);
            return;
          }
          return Fa(h, t), xr(r, t), t;
        default:
          return;
      }
    }
...
function Fa(r, t) {
  ...
  return t = t || [], yt(t, Mt(Vi(s, n, e + 1 / 3) * 255), Mt(Vi(s, n, e) * 255), Mt(Vi(s, n, e - 1 / 3) * 255), 1), r.length === 4 && (t[3] = r[3]), t;
}
function Vh(r) {
  if (r) {
...
function Un(r, t) {
  ...
  if (e) {
    ...
    return Ae(e, e.length === 4 ? "rgba" : "rgb");
  }
}
function Ic(r, t, e) {
  if (!(!(t && t.length) || !(r >= 0 && r <= 1))) {
    ...
    return e[0] = Mt(Vt(s[0], o[0], f)), e[1] = Mt(Vt(s[1], o[1], f)), e[2] = Mt(Vt(s[2], o[2], f)), e[3] = Te(Vt(s[3], o[3], f)), e;
  }
}
function Ec(r, t, e) {
  if (!(!(t && t.length) || !(r >= 0 && r <= 1))) {
    var i = r * (t.length - 1), a = Math.floor(i), n = Math.ceil(i), s = Pt(t[a]), o = Pt(t[n]), f = i - a, h = Ae([Mt(Vt(s[0], o[0], f)), Mt(Vt(s[1], o[1], f)), Mt(Vt(s[2], o[2], f)), Te(Vt(s[3], o[3], f))], "rgba");
    return e ? { color: h, leftIndex: a, rightIndex: n, value: i } : h;
  }
}
function Fc(r, t, e, i) {
  var a = Pt(r);
  if (r) return a = Vh(a), t != null && (a[0] = $h(t)), e != null && (a[1] = Cr(e)), i != null && (a[2] = Cr(i)), Ae(Fa(a), "rgba");
}
function Oc(r, t) {
  var e = Pt(r);
  if (e && t != null) return e[3] = Te(t), Ae(e, "rgba");
}
function Ae(r, t) {
  if (!(!r || !r.length)) {
    var e = r[0] + "," + r[1] + "," + r[2];
...
function Zh(r) {
  if (kt(r)) {
    var t = Wn.get(r);
    return t || (t = Un(r, -0.1), Wn.put(r, t)), t;
  } else if (xi(r)) {
    var e = z({}, r);
    return e.colorStops = Z(r.colorStops, function(i) {
      return { offset: i.offset, color: Un(i.color, -0.1) };
    }), e;
  }
  return r;
}
...
function Kh(r) {
  return "matrix(" + Ye(r[0]) + "," + Ye(r[1]) + "," + Ye(r[2]) + "," + Ye(r[3]) + "," + Oa(r[4]) + "," + Oa(r[5]) + ")";
}
var Qh = { left: "start", right: "end", center: "middle", middle: "middle" };
function Jh(r, t, e) {
...
function Go(r) {
  var t = r.x || 0, e = r.y || 0, i = (r.rotation || 0) * ii, a = $(r.scaleX, 1), n = $(r.scaleY, 1), s = r.skewX || 0, o = r.skewY || 0, f = [];
  return (t || e) && f.push("translate(" + t + "px," + e + "px)"), i && f.push("rotate(" + i + ")"), (a !== 1 || n !== 1) && f.push("scale(" + a + "," + n + ")"), (s || o) && f.push("skew(" + di(s * ii) + "deg, " + di(o * ii) + "deg)"), f.join(" ");
}
var eu = function() {
  return X.hasGlobalWindow && Re(window.btoa) ? function(r) {
...
function nu(r, t, e) {
  ...
  if (!(!i.push || !a.push)) {
    ...
    if (n !== s) {
      var o = n > s;
      if (o) i.length = s;
      else for (var f = n; f < s; f++) i.push(e === 1 ? a[f] : ka.call(a[f]));
    }
...
function ai(r) {
  if (Ot(r)) {
    var t = r.length;
    if (Ot(r[0])) {
      for (var e = [], i = 0; i < t; i++) e.push(ka.call(r[i]));
      return e;
    }
    return ka.call(r);
  }
...
var Xe = 0, si = 1, Xo = 2, ue = 3, Ba = 4, Ha = 5, Vn = 6;
function Zn(r) {
  return r === Ba || r === Ha;
}
function Ue(r) {
...
var ne = [0, 0, 0, 0], ou = function() {
  ...
  return r.prototype.isFinished = function() {
    ...
    var a = this.keyframes, n = a.length, s = false, o = Vn, f = e;
    if (Ot(e)) {
      var h = su(e);
      o = h, (h === 1 && !de(e[0]) || h === 2 && !de(e[0][0])) && (s = true);
    } else if (de(e) && !jf(e)) o = Xe;
    else if (kt(e)) if (!isNaN(+e)) o = Xe;
    else {
      var u = Pt(e);
      u && (f = u, o = ue);
    }
      ...
      v.colorStops = Z(e.colorStops, function(c) {
        return { offset: c.offset, color: Pt(c.color) };
      }), Ho(e) ? o = Ba : zo(e) && (o = Ha), f = v;
    }
    n === 0 ? this.valType = o : (o !== this.valType || o === Vn) && (s = true), this.discrete = this.discrete || s;
    var l = { time: t, value: f, rawValue: e, percent: 0 };
    return i && (l.easing = i, l.easingFunc = Re(i) ? i : ye[i] || vn(i)), a.push(l), l;
  }, r.prototype.prepare = function(t, e) {
    var i = this.keyframes;
    this._needsSort && i.sort(function(_, d) {
      return _.time - d.time;
    });
    for (var a = this.valType, n = i.length, s = i[n - 1], o = this.discrete, f = Ue(a), h = Zn(a), u = 0; u < n; u++) {
      var v = i[u], l = v.value, c = s.value;
      v.percent = v.time / t, o || (f && u !== n - 1 ? nu(l, c, a) : h && au(l.colorStops, c.colorStops));
    }
    if (!o && a !== Ha && e && this.needsAnimate() && e.needsAnimate() && a === e.valType && !e._finished) {
      this._additiveTrack = e;
      for (var p = i[0].value, u = 0; u < n; u++) a === Xe ? i[u].additiveValue = i[u].value - p : a === ue ? i[u].additiveValue = Ge([], i[u].value, p, -1) : Ue(a) && (i[u].additiveValue = a === si ? Ge([], i[u].value, p, -1) : $n([], i[u].value, p, -1));
    }
  }, r.prototype.step = function(t, e) {
    if (!this._finished) {
      this._additiveTrack && this._additiveTrack._finished && (this._additiveTrack = null);
      var i = this._additiveTrack != null, a = i ? "additiveValue" : "value", n = this.valType, s = this.keyframes, o = s.length, f = this.propName, h = n === ue, u, v = this._lastFr, l = Math.min, c, p;
      if (o === 1) c = p = s[0];
      else {
        if (e < 0) u = 0;
      ...
      if (c && p) {
        ...
        var y = i ? this._additiveValue : h ? ne : t[f];
        if ((Ue(n) || h) && !y && (y = this._additiveValue = []), this.discrete) t[f] = g < 1 ? c.rawValue : p.rawValue;
        else if (Ue(n)) n === si ? Zi(y, c[a], p[a], g) : iu(y, c[a], p[a], g);
        else if (Zn(n)) {
          var m = c[a], w = p[a], S = n === Ba;
          t[f] = { type: S ? "linear" : "radial", x: Yt(m.x, w.x, g), y: Yt(m.y, w.y, g), colorStops: Z(m.colorStops, function(T, C) {
            var M = w.colorStops[C];
            return { offset: Yt(T.offset, M.offset, g), color: ni(Zi([], T.color, M.color, g)) };
          }), global: w.global }, S ? (t[f].x2 = Yt(m.x2, w.x2, g), t[f].y2 = Yt(m.y2, w.y2, g)) : t[f].r = Yt(m.r, w.r, g);
        } else if (h) Zi(y, c[a], p[a], g), i || (t[f] = ni(y));
        else {
          var b = Yt(c[a], p[a], g);
    ...
    e === Xe ? t[i] = t[i] + a : e === ue ? (Pt(t[i], ne), Ge(ne, ne, a, 1), t[i] = ni(ne)) : e === si ? Ge(t[i], t[i], a, 1) : e === Xo && $n(t[i], t[i], a, 1);
  }, r;
}(), cn = function() {
  function r(t, e, i, a) {
    if (this._tracks = {}, this._trackKeys = [], this._maxTime = 0, this._started = 0, this._clip = null, this._target = t, this._loop = e, e && a) {
      hn("Can' use additive animation on looped animation.");
      return;
    }
  ...
  return r.prototype.getMaxTime = function() {
    ...
    for (var n = this._tracks, s = 0; s < i.length; s++) {
      ...
      if (!f) {
        ...
        if (u) {
          ...
          h = l && l.value, u.valType === ue && h && (h = ni(h));
    ...
    if (!(this._started > 0)) {
      ...
      if (i.length || this._force) {
        var l = new Wh({ life: a, loop: this._loop, delay: this._delay || 0, onframe: function(c) {
          e._started = 2;
...
var fu = function(r) {
  ...
  return t.prototype.addClip = function(e) {
    ...
    for (var i = Gr() - this._pausedTime, a = i - this._time, n = this._head; n; ) {
    ...
    this._running || (this._time = Gr(), this._pausedTime = 0, this._startLoop());
  }, t.prototype.stop = function() {
    this._running = false;
  }, t.prototype.pause = function() {
    this._paused || (this._pauseStart = Gr(), this._paused = true);
  }, t.prototype.resume = function() {
    this._paused && (this._pausedTime += Gr() - this._pauseStart, this._paused = false);
    ...
    i = i || {}, this.start();
    var a = new cn(e, i.loop);
    return this.addAnimator(a), a;
  }, t;
}(jr), hu = 300, Ki = X.domSupported, Qi = function() {
...
}(), Kn = { mouse: ["mousemove", "mouseup"], pointer: ["pointermove", "pointerup"] }, Qn = false;
function za(r) {
  var t = r.pointerType;
...
function vu(r, t) {
  return St(r.dom, new lu(r, t), true);
}
function Uo(r, t) {
...
var lu = /* @__PURE__ */ function() {
  ...
  r = St(this.dom, r), this.__togglePointerCapture(false), this.trigger("mouseup", r);
}, mouseout: function(r) {
  r = St(this.dom, r);
  var t = r.toElement || r.relatedTarget;
  Uo(this, t) || (this.__pointerCapturing && (r.zrEventControl = "no_globalout"), this.trigger("mouseout", r));
}, wheel: function(r) {
  Qn = true, r = St(this.dom, r), this.trigger("mousewheel", r);
}, mousewheel: function(r) {
  Qn || (r = St(this.dom, r), this.trigger("mousewheel", r));
}, touchstart: function(r) {
  r = St(this.dom, r), Ji(r), this.__lastTouchMoment = /* @__PURE__ */ new Date(), this.handler.processGesture(r, "start"), Ct.mousemove.call(this, r), Ct.mousedown.call(this, r);
}, touchmove: function(r) {
  r = St(this.dom, r), Ji(r), this.handler.processGesture(r, "change"), Ct.mousemove.call(this, r);
}, touchend: function(r) {
  r = St(this.dom, r), Ji(r), this.handler.processGesture(r, "end"), Ct.mouseup.call(this, r), +/* @__PURE__ */ new Date() - +this.__lastTouchMoment < hu && Ct.click.call(this, r);
}, pointerdown: function(r) {
  Ct.mousedown.call(this, r);
}, pointermove: function(r) {
  za(r) || Ct.mousemove.call(this, r);
}, pointerup: function(r) {
  Ct.mouseup.call(this, r);
}, pointerout: function(r) {
  za(r) || Ct.mouseout.call(this, r);
} };
...
var Na = { pointermove: function(r) {
  za(r) || Na.mousemove.call(this, r);
}, pointerup: function(r) {
  Na.mouseup.call(this, r);
}, mousemove: function(r) {
...
function cu(r, t) {
  var e = t.domHandlers;
  X.pointerEventsSupported ? nt(Qi.pointer, function(i) {
    oi(t, i, function(a) {
      e[i].call(r, a);
    });
  }) : (X.touchEventsSupported && nt(Qi.touch, function(i) {
    oi(t, i, function(a) {
      e[i].call(r, a), uu(t);
    });
  }), nt(Qi.mouse, function(i) {
    oi(t, i, function(a) {
      a = un(a), t.touching || e[i].call(r, a);
    });
  }));
}
function du(r, t) {
  X.pointerEventsSupported ? nt(Kn.pointer, e) : X.touchEventsSupported || nt(Kn.mouse, e);
  function e(i) {
    function a(n) {
      n = un(n), Uo(r, n.target) || (n = vu(r, n), t.domHandlers[i].call(r, n));
    }
    oi(t, i, a, { capture: true });
  }
}
function oi(r, t, e, i) {
  r.mounted[t] = e, r.listenerOpts[t] = i, bh(r.domTarget, t, e, i);
}
function ji(r) {
  var t = r.mounted;
  for (var e in t) t.hasOwnProperty(e) && Sh(r.domTarget, e, t[e], r.listenerOpts[e]);
  r.mounted = {};
}
var Jn = /* @__PURE__ */ function() {
  ...
  function t(e, i) {
    ...
    return a.__pointerCapturing = false, a.dom = e, a.painterRoot = i, a._localHandlerScope = new Jn(e, Ct), Ki && (a._globalHandlerScope = new Jn(document, Na)), cu(a, a._localHandlerScope), a;
  }
  return t.prototype.dispose = function() {
    ji(this._localHandlerScope), Ki && ji(this._globalHandlerScope);
  }, t.prototype.setCursor = function(e) {
    this.dom.style && (this.dom.style.cursor = e || "default");
  }, t.prototype.__togglePointerCapture = function(e) {
    if (this.__mayPointerCapture = null, Ki && +this.__pointerCapturing ^ +e) {
...
X.hasGlobalWindow && (Wo = Math.max(window.devicePixelRatio || window.screen && window.screen.deviceXDPI / window.screen.logicalXDPI || 1, 1));
var pi = Wo, Ya = 0.4, Ga = "#333", Xa = "#ccc", gu = "#eee", jn = Lh, ts = 5e-5;
function ar(r) {
  return r > ts || r < -ts;
}
var nr = [], Rr = [], ta = Sr(), ra = Math.abs, dn = function() {
  function r() {
  }
  return r.prototype.getLocalTransform = function(t) {
    ...
    if (!(e || t)) {
      i && (jn(i), this.invTransform = null);
      return;
    }
    i = i || Sr(), e ? this.getLocalTransform(i) : jn(i), t && (e ? _e(i, t, i) : So(i, t)), this.transform = i, this._resolveGlobalScaleRatio(i);
    ...
    this.invTransform = this.invTransform || Sr(), xh(this.invTransform, t);
    ...
    if (this.transform) {
      ...
      t && t.transform && (t.invTransform = t.invTransform || Sr(), _e(Rr, t.invTransform, e), e = Rr);
      var i = this.originX, a = this.originY;
      (i || a) && (ta[4] = i, ta[5] = a, _e(Rr, e, ta), Rr[4] -= i, Rr[5] -= a, e = Rr), this.setLocalTransform(e);
    }
    ...
    return t && ra(t[0] - 1) > 1e-10 && ra(t[3] - 1) > 1e-10 ? Math.sqrt(ra(t[0] * t[3] - t[2] * t[1])) : 1;
    ...
    return e[0] = n, e[3] = s, e[1] = c * n, e[2] = l * s, h && Co(e, e, h), e[4] += i + u, e[5] += a + v, e;
  }, r.initDefaultProps = function() {
    var t = r.prototype;
    t.scaleX = t.scaleY = t.globalScaleRatio = 1, t.x = t.y = t.originX = t.originY = t.skewX = t.skewY = t.rotation = t.anchorX = t.anchorY = 0;
  }(), r;
}(), Se = ["x", "y", "originX", "originY", "anchorX", "anchorY", "rotation", "scaleX", "scaleY", "skewX", "skewY"];
function qo(r, t) {
...
function dt(r, t) {
  ...
  e || (e = rs[t] = new Ai(500));
  var i = e.get(r);
  return i == null && (i = Mi.measureText(r, t).width, e.put(r, i)), i;
}
function es(r, t, e, i) {
  var a = dt(r, t), n = Ii(t), s = ve(0, a, e), o = kr(0, n, i), f = new U(s, o, a, n);
  return f;
}
function _u(r, t, e, i) {
  var a = ((r || "") + "").split(`
`), n = a.length;
  if (n === 1) return es(a[0], t, e, i);
...
function yu(r, t, e) {
  ...
  if (i instanceof Array) f += Ce(i[0], e.width), h += Ce(i[1], e.height), u = null, v = null;
  else switch (i) {
    case "left":
...
var ea = "__zr_normal__", ia = Se.concat(["ignore"]), mu = Li(Se, function(r, t) {
  return r[t] = true, r;
}, { ignore: false }), Ar = {}, wu = new U(0, 0, 0, 0), Ei = function() {
  function r(t) {
    this.id = go(), this.animators = [], this.currentStates = [], this.states = {}, this._init(t);
  }
  return r.prototype._init = function(t) {
    ...
    if (e && (!e.ignore || t)) {
      ...
      if (n.copyTransform(e), i.position != null) {
        ...
        if (v && i.rotation != null) {
          ...
          v === "center" ? (l = u.width * 0.5, c = u.height * 0.5) : (l = Ce(v[0], u.width), c = Ce(v[1], u.height)), h = true, n.originX = -n.x + l + (a ? 0 : u.x), n.originY = -n.y + c + (a ? 0 : u.y);
        }
      }
    ...
    return this.__zr && this.__zr.isDarkMode() ? Xa : Ga;
    ...
    e || (e = this._normalState = {}), t.textConfig && !e.textConfig && (e.textConfig = this.textConfig), this._savePrimaryToNormal(t, e, ia);
    ...
    if (!(!s && n)) {
      ...
      if (!(Et(o, t) >= 0 && (e || o.length === 1))) {
        ...
        return v && v.useState(t, e, i, u), l && l.useState(t, e, i, u), n ? (this.currentStates = [], this._normalState = {}) : e ? this.currentStates.push(t) : this.currentStates = [t], this._updateAnimationTargets(), this.markRedraw(), !u && this.__inHover && (this._toggleHoverLayerFlag(false), this.__dirty &= ~ct), h;
      }
    }
    ...
    if (!t.length) this.clearStates();
      ...
      _ && _.useStates(t, e, l), d && d.useStates(t, e, l), this._updateAnimationTargets(), this.currentStates = t.slice(), this.markRedraw(), !l && this.__inHover && (this._toggleHoverLayerFlag(false), this.__dirty &= ~ct);
    }
    ...
    var a = this.currentStates.slice(), n = Et(a, t), s = Et(a, e) >= 0;
    ...
    for (var f = {}, h = false, u = 0; u < ia.length; u++) {
      var v = ia[u], l = n && mu[v];
    ...
    var e = this._textContent;
    e !== t && (e && e !== t && this.removeTextContent(), t.innerTransformable = new dn(), this._attachComponent(t), this._textContent = t, this.markRedraw());
    ...
    var a = t ? this[t] : this, n = new cn(a, e, i);
    ...
    for (var n = aa(this, e, i, a), s = 0; s < n.length; s++) n[s].__fromStateTransition = t;
    ...
    var t = r.prototype;
    t.type = "element", t.name = "", t.ignore = t.silent = t.isGroup = t.draggable = t.dragging = t.ignoreClip = t.__inHover = false, t.__dirty = ct;
    function e(i, a, n, s) {
...
function bu(r, t, e) {
  if (Ot(t[e])) if (Ot(r[e]) || (r[e] = []), Qf(t[e])) {
    var i = t[e].length;
    r[e].length !== i && (r[e] = new t[e].constructor(i), na(r[e], t[e], i));
  } else {
    var a = t[e], n = r[e], s = a.length;
    if (Tu(a)) for (var o = a[0].length, f = 0; f < s; f++) n[f] ? na(n[f], a[f], o) : n[f] = Array.prototype.slice.call(a[f]);
    else na(n, a, s);
    n.length = a.length;
  }
  else r[e] = t[e];
...
function $o(r, t, e, i, a, n, s, o) {
  ...
  if (a.force || (_ = Pa(_, function(L) {
    ...
    var S = new cn(e, false, false, v ? Pa(p, function(R) {
...
var yr = function(r) {
  ...
  return t.prototype.childrenRef = function() {
    ...
    var i = this.__zr, a = this._children, n = Et(a, e);
...
function Pu(r) {
  if (!r) return false;
  if (typeof r == "string") return ci(r, 1) < Ya;
  if (r.colorStops) {
    for (var t = r.colorStops, e = 0, i = t.length, a = 0; a < i; a++) e += ci(t[a].color, 1);
    return e /= i, e < Ya;
  }
  return false;
}
var Lu = function() {
  function r(t, e, i) {
    ...
    var n = new Hh(), s = i.renderer || "canvas";
    ...
    var h = !X.node && !X.worker && !f ? new pu(o.getViewportRoot(), o.root) : null, u = i.useCoarsePointer, v = u == null || u === "auto" ? X.touchEventsSupported : !!u, l = 44, c;
    v && (c = $(i.pointerSize, l)), this.handler = new Lo(n, o, h, o.root, c), this.animation = new fu({ stage: { update: f ? null : function() {
...
var Ua;
function xu(r) {
  if (typeof Ua == "function") return Ua(r);
}
function Hc(r) {
  Ua = r;
}
...
function pn(r, t, e, i, a) {
  if (r) if (typeof r == "string") {
    if (t && t.__zrImageSrc === r || !e) return t;
    var n = Wa.get(r), s = { hostEl: e, cb: i, cbPayload: a };
    return n ? (t = n.image, !Fi(t) && n.pending.push(s)) : (t = Mi.loadImage(r, is, is), t.__zrImageSrc = r, Wa.put(r, t.__cachedImgObj = { image: t, pending: [s] })), t;
  } else return r;
  else return t;
}
function is() {
...
`);
  n = Zo(e, i, a, n);
  for (var o = false, f = {}, h = 0, u = s.length; h < u; h++) Ko(f, s[h], n), s[h] = f.textLine, o = o || f.isTruncated;
  r.text = s.join(`
`), r.isTruncated = o;
}
function Zo(r, t, e, i) {
  ...
  a.cnCharWidth = dt("\u56FD", t);
  var s = a.ascCharWidth = dt("a", t);
...
function Iu(r, t) {
  r != null && (r += "");
  var e = t.overflow, i = t.padding, a = t.font, n = e === "truncate", s = Ii(a), o = $(t.lineHeight, s), f = !!t.backgroundColor, h = t.lineOverflow === "truncate", u = false, v = t.width, l;
  v != null && (e === "break" || e === "breakAll") ? l = r ? Qo(r, t.font, v, e === "breakAll", 0).lines : [] : l = r ? r.split(`
`) : [];
  ...
  if (r && n && v != null) for (var d = Zo(v, a, t.ellipsis, { minChar: t.truncateMinChar, placeholder: t.placeholder }), g = {}, y = 0; y < l.length; y++) Ko(g, l[y], d), l[y] = g.textLine, u = u || g.isTruncated;
  for (var m = p, w = 0, y = 0; y < l.length; y++) w = Math.max(dt(l[y], a), w);
  v == null && (v = w);
  var S = w;
...
function Ou(r, t) {
  ...
  for (var i = t.width, a = t.height, n = t.overflow, s = (n === "break" || n === "breakAll") && i != null ? { width: i, accumWidth: 0, breakAll: n === "breakAll" } : null, o = sa.lastIndex = 0, f; (f = sa.exec(r)) != null; ) {
    var h = f.index;
    h > o && oa(e, r.substring(o, h), t, s), oa(e, f[2], t, s, f[1]), o = sa.lastIndex;
  }
  o < r.length && oa(e, r.substring(o, r.length), t, s);
  ...
  t: for (var y = 0; y < e.lines.length; y++) {
    for (var m = e.lines[y], w = 0, S = 0, b = 0; b < m.tokens.length; b++) {
      ...
      T.contentHeight = Ii(L);
      var R = $(C.height, T.contentHeight);
      if (T.innerHeight = R, M && (R += M[0] + M[2]), T.height = R, T.lineHeight = ei(C.lineHeight, t.lineHeight, R), T.align = C && C.align || t.align, T.verticalAlign = C && C.verticalAlign || "middle", _ && a != null && v + T.lineHeight > a) {
      ...
      if (typeof x == "string" && x.charAt(x.length - 1) === "%") T.percentWidth = x, u.push(T), T.contentWidth = dt(T.text, L);
      else {
        if (E) {
          var D = C.backgroundColor, F = D && D.image;
          F && (F = Ru(F), Fi(F) && (T.width = Math.max(T.width, F.width * R / F.height)));
        }
        var H = p && i != null ? i - S : null;
        H != null && H < T.width ? !E || H < P ? (T.text = "", T.width = T.contentWidth = 0) : (Au(d, T.text, H - P, L, t.ellipsis, { minChar: t.truncateMinChar }), T.text = d.text, e.isTruncated = e.isTruncated || d.isTruncated, T.width = T.contentWidth = dt(T.text, L)) : T.contentWidth = dt(T.text, L);
      }
...
`);
  for (var d = 0; d < u.length; d++) {
    var g = u[d], y = new Eu();
    if (y.styleName = a, y.text = g, y.isLineHolder = !g && !n, typeof s.width == "number" ? y.width = s.width : y.width = v ? v[d] : dt(g, f), !d && !h) {
      var m = (o[o.length - 1] || (o[0] = new as())).tokens, w = m.length;
      w === 1 && m[0].isLineHolder ? m[0] = y : (g || !w || n) && m.push(y);
    } else o.push(new as([y]));
  }
}
function ku(r) {
...
var qa = "__zr_style_" + Math.round(Math.random() * 10), Mr = { shadowBlur: 0, shadowOffsetX: 0, shadowOffsetY: 0, shadowColor: "#000", opacity: 1, blend: "source-over" }, Oi = { style: { shadowBlur: true, shadowOffsetX: true, shadowOffsetY: true, shadowColor: true, opacity: true } };
Mr[qa] = true;
var ns = ["z", "z2", "invisible"], zu = ["invisible"], De = function(r) {
  N(t, r);
  function t(e) {
  ...
  return t.prototype._init = function(e) {
    ...
    e || this.markRedraw(), this.__dirty |= he, this._rect && (this._rect = null);
  }, t.prototype.dirty = function() {
    this.dirtyStyle();
  }, t.prototype.styleChanged = function() {
    return !!(this.__dirty & he);
  }, t.prototype.styleUpdated = function() {
    this.__dirty &= ~he;
  }, t.prototype.createStyle = function(e) {
    return Ri(Mr, e);
  }, t.prototype.useStyle = function(e) {
    e[qa] || (e = this.createStyle(e)), this.__inHover ? this.__hoverStyle = e : this.style = e, this.dirtyStyle();
  }, t.prototype.isStyleObject = function(e) {
    return e[qa];
  }, t.prototype._innerSaveToNormal = function(e) {
    r.prototype._innerSaveToNormal.call(this, e);
    var i = this._normalState;
    e.style && !i.style && (i.style = this._mergeStyle(this.createStyle(), this.style)), this._savePrimaryToNormal(e, i, ns);
    ...
    for (var _ = this.__inHover ? zu : ns, l = 0; l < _.length; l++) {
      var c = _[l];
    ...
    var e = t.prototype;
    e.type = "displayable", e.invisible = false, e.z = 0, e.z2 = 0, e.zlevel = 0, e.culling = false, e.cursor = "pointer", e.rectHover = false, e.incremental = false, e._rect = null, e.dirtyRectTolerance = 0, e.__dirty = ct | he;
  }(), t;
}(Ei), fa = new U(0, 0, 0, 0), ha = new U(0, 0, 0, 0);
function Nu(r, t, e) {
  return fa.copy(r.getBoundingRect()), r.transform && fa.applyTransform(r.transform), ha.width = t, ha.height = e, !fa.intersect(ha);
}
var ht = Math.min, ut = Math.max, ua = Math.sin, va = Math.cos, sr = Math.PI * 2, We = Jr(), qe = Jr(), $e = Jr();
function Jo(r, t, e) {
  if (r.length !== 0) {
...
function Gu(r, t, e, i, a, n, s, o) {
  var f = Fo, h = at, u = ut(ht(f(r, e, a), 1), 0), v = ut(ht(f(t, i, n), 1), 0), l = h(r, e, a, u), c = h(t, i, n, v);
  s[0] = ht(r, a, l), s[1] = ht(t, n, c), o[0] = ut(r, a, l), o[1] = ut(t, n, c);
}
function Xu(r, t, e, i, a, n, s, o, f) {
  var h = Nr, u = Yr, v = Math.abs(a - n);
  if (v % sr < 1e-4 && v > 1e-4) {
    o[0] = r - e, o[1] = t - i, f[0] = r + e, f[1] = t + i;
    return;
  }
  if (We[0] = va(a) * e + r, We[1] = ua(a) * i + t, qe[0] = va(n) * e + r, qe[1] = ua(n) * i + t, h(o, We, qe), u(f, We, qe), a = a % sr, a < 0 && (a = a + sr), n = n % sr, n < 0 && (n = n + sr), a > n && !s ? n += sr : a < n && s && (a += sr), s) {
    var l = n;
    n = a, a = l;
  }
  for (var c = 0; c < n; c += Math.PI / 2) c > a && ($e[0] = va(c) * e + r, $e[1] = ua(c) * i + t, h(o, $e, o), u(f, $e, f));
}
var B = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 }, or = [], fr = [], Lt = [], Ut = [], xt = [], Rt = [], la = Math.min, ca = Math.max, hr = Math.cos, ur = Math.sin, Nt = Math.abs, $a = Math.PI, qt = $a * 2, da = typeof Float32Array < "u", se = [];
function pa(r) {
  var t = Math.round(r / $a * 1e8) / 1e8;
  return t % 2 * $a;
}
function Uu(r, t) {
  var e = pa(r[0]);
  e < 0 && (e += qt);
  var i = e - r[0], a = r[1];
  a += i, !t && a - e >= qt ? a = e + qt : t && e - a >= qt ? a = e - qt : !t && e > a ? a = e + (qt - pa(e - a)) : t && e < a && (a = e - (qt - pa(a - e))), r[0] = e, r[1] = a;
}
var jt = function() {
  function r(t) {
  ...
  return r.prototype.increaseVersion = function() {
    ...
    i = i || 0, i > 0 && (this._ux = Nt(i / pi / t) || 0, this._uy = Nt(i / pi / e) || 0);
    ...
    this._drawPendingPt(), se[0] = a, se[1] = n, Uu(se, s), a = se[0], n = se[1];
    var o = n - a;
    ...
    var e = t.length;
    !(this.data && this.data.length === e) && da && (this.data = new Float32Array(e));
    ...
    da && this.data instanceof Float32Array && (this.data = new Float32Array(a + i));
    ...
    if (this._saveData) {
      this._drawPendingPt();
      var t = this.data;
      t instanceof Array && (t.length = this._len, da && this._len > 11 && (this.data = new Float32Array(t)));
    }
  }, r.prototype.getBoundingRect = function() {
    Lt[0] = Lt[1] = xt[0] = xt[1] = Number.MAX_VALUE, Ut[0] = Ut[1] = Rt[0] = Rt[1] = -Number.MAX_VALUE;
    var t = this.data, e = 0, i = 0, a = 0, n = 0, s;
    for (s = 0; s < this._len; ) {
      var o = t[s++], f = s === 1;
      switch (f && (e = t[s], i = t[s + 1], a = e, n = i), o) {
        case B.M:
          e = a = t[s++], i = n = t[s++], xt[0] = a, xt[1] = n, Rt[0] = a, Rt[1] = n;
          break;
        case B.L:
          ss(e, i, t[s], t[s + 1], xt, Rt), e = t[s++], i = t[s++];
          break;
        case B.C:
          Yu(e, i, t[s++], t[s++], t[s++], t[s++], t[s], t[s + 1], xt, Rt), e = t[s++], i = t[s++];
          break;
        case B.Q:
          Gu(e, i, t[s++], t[s++], t[s], t[s + 1], xt, Rt), e = t[s++], i = t[s++];
          break;
        case B.A:
          var h = t[s++], u = t[s++], v = t[s++], l = t[s++], c = t[s++], p = t[s++] + c;
          s += 1;
          var _ = !t[s++];
          f && (a = hr(c) * v + h, n = ur(c) * l + u), Xu(h, u, v, l, c, p, _, xt, Rt), e = hr(p) * v + h, i = ur(p) * l + u;
          break;
        case B.R:
          a = e = t[s++], n = i = t[s++];
          var d = t[s++], g = t[s++];
          ss(a, n, a + d, n + g, xt, Rt);
          break;
        case B.Z:
          e = a, i = n;
          break;
      }
      Nr(Lt, Lt, xt), Yr(Ut, Ut, Rt);
    }
    return s === 0 && (Lt[0] = Lt[1] = Ut[0] = Ut[1] = 0), new U(Lt[0], Lt[1], Ut[0] - Lt[0], Ut[1] - Lt[1]);
    ...
    for (var h = this._pathSegLen, u = 0, v = 0, l = 0; l < e; ) {
      ...
      switch (c) {
        ...
        case B.C: {
          ...
          _ = Nh(n, s, w, S, d, g, b, T, 10), n = b, s = T;
          break;
        }
        case B.Q: {
          var w = t[l++], S = t[l++], d = t[l++], g = t[l++];
          _ = Xh(n, s, w, S, d, g, 10), n = d, s = g;
          break;
        }
        case B.A:
          var C = t[l++], M = t[l++], P = t[l++], L = t[l++], R = t[l++], A = t[l++], x = A + R;
          l += 1, p && (o = hr(R) * P + C, f = ur(R) * L + M), _ = ca(P, L) * la(qt, Math.abs(A)), n = hr(x) * P + C, s = ur(x) * L + M;
          break;
        case B.R: {
          o = n = t[l++], f = s = t[l++];
          var E = t[l++], D = t[l++];
      ...
      switch (C && (h = i[b], u = i[b + 1], o = h, f = u), T !== B.L && m > 0 && (t.lineTo(w, S), m = 0), T) {
        ...
        case B.Q: {
          ...
          if (c) {
            ...
            if (d + L > y) {
              var R = (y - d) / L;
              li(h, x, D, R, or), li(u, E, F, R, fr), t.quadraticCurveTo(or[1], fr[1], or[2], fr[2]);
              break t;
            }
            d += L;
          }
        ...
        case B.A:
          var V = i[b++], W = i[b++], Y = i[b++], et = i[b++], tt = i[b++], pt = i[b++], Bt = i[b++], Ht = !i[b++], gt = Y > et ? Y : et, Q = Nt(Y - et) > 1e-3, q = tt + pt, I = false;
          if (c) {
            var L = p[g++];
            d + L > y && (q = tt + pt * (y - d) / L, I = true), d += L;
          }
          if (Q && t.ellipse ? t.ellipse(V, W, Y, et, Bt, tt, q, Ht) : t.arc(V, W, gt, tt, q, Ht), I) break t;
        ...
        case B.R:
          ...
          if (c) {
            ...
            if (d + L > y) {
              var ot = y - d;
              t.moveTo(v, l), t.lineTo(v + la(ot, O), l), ot -= O, ot > 0 && t.lineTo(v + O, l + la(ot, zt)), ot -= zt, ot > 0 && t.lineTo(v + ca(O - ot, 0), l + zt), ot -= O, ot > 0 && t.lineTo(v, l + ca(zt - ot, 0));
              break t;
            }
            d += L;
          }
...
function Wu(r, t, e, i, a, n, s, o, f, h, u) {
  ...
  var l = zh(r, t, e, i, a, n, s, o, h, u, null);
  return l <= v / 2;
}
function qu(r, t, e, i, a, n, s, o, f) {
  ...
  var u = Gh(r, t, e, i, a, n, o, f, null);
  return u <= h / 2;
}
var hs = Math.PI * 2;
function Ve(r) {
  return r %= hs, r < 0 && (r += hs), r;
}
var oe = Math.PI * 2;
function $u(r, t, e, i, a, n, s, o, f) {
  ...
  if (Math.abs(i - a) % oe < 1e-4) return true;
  if (n) {
    var v = i;
    i = Ve(a), a = Ve(v);
  } else i = Ve(i), a = Ve(a);
  ...
  return l < 0 && (l += oe), l >= i && l <= a || l + oe >= i && l + oe <= a;
}
...
function Qu(r, t, e, i, a, n, s, o, f, h) {
  ...
  var u = Io(t, i, n, o, h, st);
  if (u === 0) return 0;
  for (var v = 0, l = -1, c = void 0, p = void 0, _ = 0; _ < u; _++) {
    var d = st[_], g = d === 0 || d === 1 ? 0.5 : 1, y = rt(r, e, a, s, d);
    y < f || (l < 0 && (l = Eo(t, i, n, o, mt), mt[1] < mt[0] && l > 1 && Ku(), c = rt(t, i, n, o, mt[0]), l > 1 && (p = rt(t, i, n, o, mt[1]))), l === 2 ? d < mt[0] ? v += c < t ? g : -g : d < mt[1] ? v += p < c ? g : -g : v += o < p ? g : -g : d < mt[0] ? v += c < t ? g : -g : v += o < c ? g : -g);
  }
  return v;
}
...
function tv(r, t, e) {
  return jo(r, 0, false, t, e);
}
function rv(r, t, e, i) {
  return jo(r, t, true, e, i);
}
var gi = Tt({ fill: "#000", stroke: null, strokePercent: 1, fillOpacity: 1, strokeOpacity: 1, lineDashOffset: 0, lineWidth: 1, lineCap: "butt", miterLimit: 10, strokeNoScale: false, strokeFirst: false }, Mr), ev = { style: Tt({ fill: true, stroke: true, strokePercent: true, fillOpacity: true, strokeOpacity: true, lineDashOffset: true, lineWidth: true, miterLimit: true }, Oi.style) }, ga = Se.concat(["invisible", "culling", "z", "z2", "zlevel", "parent"]), K = function(r) {
  N(t, r);
  function t(e) {
    return r.call(this, e) || this;
  }
  return t.prototype.update = function() {
    ...
    if (i.decal) {
      ...
      for (var o = 0; o < ga.length; ++o) a[ga[o]] = this[ga[o]];
      a.__dirty |= ct;
    ...
    if (kt(i)) {
      var a = this.__zr, n = !!(a && a.isDarkMode()), s = ci(e, 0) < Ya;
      if (n === s) return i;
    }
    ...
    if (a) {
      ...
      var s = this.path;
      (n || this.__dirty & Or) && (s.beginPath(), this.buildPath(s, this.shape, false), this.pathUpdated()), e = s.getBoundingRect();
    }
    ...
    this.__dirty |= Or, this._rect && (this._rect = null), this._decalEl && this._decalEl.dirtyShape(), this.markRedraw();
  }, t.prototype.dirty = function() {
    ...
    var e = t.prototype;
    e.type = "path", e.strokeContainThreshold = 5, e.segmentIgnoreThreshold = 0, e.subPixelOptimize = false, e.autoBatch = false, e.__dirty = ct | he | Or;
  }(), t;
}(De), iv = Tt({ strokeFirst: true, font: Qt, x: 0, y: 0, textAlign: "left", textBaseline: "top", miterLimit: 2 }, gi), Kr = function(r) {
  N(t, r);
  function t() {
...
Kr.prototype.type = "tspan";
var av = Tt({ x: 0, y: 0 }, Mr), nv = { style: Tt({ x: true, y: true, width: true, height: true, sx: true, sy: true, sWidth: true, sHeight: true }, Oi.style) };
function sv(r) {
...
function fv(r, t, e) {
  if (t) {
    ...
    var o = e && e.lineWidth;
    return o && (Xr(i * 2) === Xr(a * 2) && (r.x1 = r.x2 = Ur(i, o, true)), Xr(n * 2) === Xr(s * 2) && (r.y1 = r.y2 = Ur(n, o, true))), r;
  }
}
function hv(r, t, e) {
  if (t) {
    ...
    var o = e && e.lineWidth;
    return o && (r.x = Ur(i, o, true), r.y = Ur(a, o, true), r.width = Math.max(Ur(i + n, o, false) - r.x, n === 0 ? 0 : 1), r.height = Math.max(Ur(a + s, o, false) - r.y, s === 0 ? 0 : 1)), r;
  }
}
function Ur(r, t, e) {
  if (!t) return r;
  var i = Xr(r * 2);
  return (i + Xr(t)) % 2 === 0 ? i / 2 : (i + (e ? 1 : -1)) / 2;
}
...
Me.prototype.type = "rect";
var us = { fill: "#000" }, vs = 2, lv = { style: Tt({ fill: true, stroke: true, fillOpacity: true, strokeOpacity: true, lineWidth: true, fontSize: true, lineHeight: true, width: true, height: true, textShadowColor: true, textShadowBlur: true, textShadowOffsetX: true, textShadowOffsetY: true, backgroundColor: true, padding: true, borderColor: true, borderWidth: true, borderRadius: true }, Oi.style) }, cv = function(r) {
  N(t, r);
  function t(e) {
    var i = r.call(this) || this;
    return i.type = "text", i._children = [], i._defaultStyle = us, i.attr(e), i;
  }
  return t.prototype.childrenRef = function() {
    return this._children;
    ...
    var e = this.style, i = e.font || Qt, a = e.padding, n = ys(e), s = Iu(n, e), o = _a(e), f = !!e.backgroundColor, h = s.outerHeight, u = s.outerWidth, v = s.contentWidth, l = s.lines, c = s.lineHeight, p = this._defaultStyle;
    this.isTruncated = !!s.isTruncated;
    var _ = e.x || 0, d = e.y || 0, g = e.align || p.align || "left", y = e.verticalAlign || p.verticalAlign || "top", m = _, w = kr(d, s.contentHeight, y);
    if (o || a) {
      var S = ve(_, u, g), b = kr(d, h, y);
      o && this._renderBackground(e, e, S, b, u, h);
    }
    w += c / 2, a && (m = _s(_, g, a), y === "top" ? w += a[0] : y === "bottom" && (w -= a[2]));
    for (var T = 0, C = false, M = gs("fill" in e ? e.fill : (C = true, p.fill)), P = ps("stroke" in e ? e.stroke : !f && (!p.autoStroke || C) ? (T = vs, p.stroke) : null), L = e.textShadowBlur > 0, R = e.width != null && (e.overflow === "truncate" || e.overflow === "break" || e.overflow === "breakAll"), A = s.calculatedLineHeight, x = 0; x < l.length; x++) {
      var E = this._getOrCreateChild(Kr), D = E.createStyle();
      E.useStyle(D), D.text = l[x], D.x = m, D.y = w, D.textAlign = g, D.textBaseline = "middle", D.opacity = e.opacity, D.strokeFirst = true, L && (D.shadowBlur = e.textShadowBlur || 0, D.shadowColor = e.textShadowColor || "transparent", D.shadowOffsetX = e.textShadowOffsetX || 0, D.shadowOffsetY = e.textShadowOffsetY || 0), D.stroke = P, D.fill = M, P && (D.lineWidth = e.lineWidth || T, D.lineDash = e.lineDash, D.lineDashOffset = e.lineDashOffset || 0), D.font = i, cs(D, e), w += c, R && E.setBoundingRect(new U(ve(D.x, v, D.textAlign), kr(D.y, A, D.textBaseline), v, A));
    }
  }, t.prototype._updateRichTexts = function() {
    var e = this.style, i = ys(e), a = Ou(i, e), n = a.width, s = a.outerWidth, o = a.outerHeight, f = e.padding, h = e.x || 0, u = e.y || 0, v = this._defaultStyle, l = e.align || v.align, c = e.verticalAlign || v.verticalAlign;
    this.isTruncated = !!a.isTruncated;
    var p = ve(h, s, l), _ = kr(u, o, c), d = p, g = _;
    f && (d += f[3], g += f[0]);
    var y = d + n;
    _a(e) && this._renderBackground(e, e, p, _, s, o);
    ...
    p && (s = _s(s, o, p), v -= e.height / 2 - p[0] - e.innerHeight / 2);
    var _ = this._getOrCreateChild(Kr), d = _.createStyle();
    _.useStyle(d);
    var g = this._defaultStyle, y = false, m = 0, w = gs("fill" in h ? h.fill : "fill" in i ? i.fill : (y = true, g.fill)), S = ps("stroke" in h ? h.stroke : "stroke" in i ? i.stroke : !c && !f && (!g.autoStroke || y) ? (m = vs, g.stroke) : null), b = h.textShadowBlur > 0 || i.textShadowBlur > 0;
    d.text = e.text, d.x = s, d.y = v, b && (d.shadowBlur = h.textShadowBlur || i.textShadowBlur || 0, d.shadowColor = h.textShadowColor || i.textShadowColor || "transparent", d.shadowOffsetX = h.textShadowOffsetX || i.textShadowOffsetX || 0, d.shadowOffsetY = h.textShadowOffsetY || i.textShadowOffsetY || 0), d.textAlign = o, d.textBaseline = "middle", d.font = e.font || Qt, d.opacity = ei(h.opacity, i.opacity, 1), cs(d, h), S && (d.lineWidth = ei(h.lineWidth, i.lineWidth, m), d.lineDash = $(h.lineDash, i.lineDash), d.lineDashOffset = i.lineDashOffset || 0, d.stroke = S), w && (d.fill = w);
    var T = e.contentWidth, C = e.contentHeight;
    _.setBoundingRect(new U(ve(d.x, T, d.textAlign), kr(d.y, C, d.textBaseline), T, C));
    ...
    if (l || e.lineHeight || h && u) {
      _ = this._getOrCreateChild(Me), _.useStyle(_.createStyle()), _.style.fill = null;
      var g = _.shape;
    ...
    if (l) {
      ...
      d = this._getOrCreateChild(te), d.onload = function() {
        p.dirtyStyle();
      };
      var m = d.style;
    ...
    var w = (_ || d).style;
    w.shadowBlur = e.shadowBlur || 0, w.shadowColor = e.shadowColor || "transparent", w.shadowOffsetX = e.shadowOffsetX || 0, w.shadowOffsetY = e.shadowOffsetY || 0, w.opacity = ei(e.opacity, i.opacity, 1);
  }, t.makeFont = function(e) {
    var i = "";
    return rf(e) && (i = [e.fontStyle, e.fontWeight, tf(e.fontSize), e.fontFamily || "sans-serif"].join(" ")), i && zr(i) || e.textFont || e.font;
  }, t;
}(De), dv = { left: true, right: 1, center: 1 }, pv = { top: 1, bottom: 1, middle: 1 }, ls = ["fontStyle", "fontWeight", "fontSize", "fontFamily"];
function tf(r) {
  return typeof r == "string" && (r.indexOf("px") !== -1 || r.indexOf("rem") !== -1 || r.indexOf("em") !== -1) ? r : isNaN(+r) ? sn + "px" : r + "px";
}
function cs(r, t) {
...
var Ir = jt.CMD, _v = [[], [], []], ms = Math.sqrt, yv = Math.atan2;
function ef(r, t) {
  if (t) {
    ...
    for (s = 0, o = 0; s < i; ) {
      switch (a = e[s++], o = s, n = 0, a) {
        ...
        case _:
          ...
          break;
        case p:
          var d = t[4], g = t[5], y = ms(t[0] * t[0] + t[1] * t[1]), m = ms(t[2] * t[2] + t[3] * t[3]), w = yv(-t[1] / m, t[0] / y);
          e[s] *= y, e[s++] += d, e[s] *= m, e[s++] += g, e[s++] *= y, e[s++] *= m, e[s++] += w, e[s++] += w, s += 2, o = s;
          break;
        case c:
          h[0] = e[s++], h[1] = e[s++], ge(h, h, t), e[o++] = h[0], e[o++] = h[1], h[0] += e[s++], h[1] += e[s++], ge(h, h, t), e[o++] = h[0], e[o++] = h[1];
      }
      for (f = 0; f < n; f++) {
        var S = _v[f];
        S[0] = e[s++], S[1] = e[s++], ge(S, S, t), e[o++] = S[0], e[o++] = S[1];
      }
    }
    r.increaseVersion();
  }
}
var ya = Math.sqrt, Ze = Math.sin, Ke = Math.cos, fe = Math.PI;
function ws(r) {
  return Math.sqrt(r[0] * r[0] + r[1] * r[1]);
}
function Va(r, t) {
  return (r[0] * t[0] + r[1] * t[1]) / (ws(r) * ws(t));
}
function Ts(r, t) {
  return (r[0] * t[1] < r[1] * t[0] ? -1 : 1) * Math.acos(Va(r, t));
}
function bs(r, t, e, i, a, n, s, o, f, h, u) {
  var v = f * (fe / 180), l = Ke(v) * (r - e) / 2 + Ze(v) * (t - i) / 2, c = -1 * Ze(v) * (r - e) / 2 + Ke(v) * (t - i) / 2, p = l * l / (s * s) + c * c / (o * o);
  p > 1 && (s *= ya(p), o *= ya(p));
  var _ = (a === n ? -1 : 1) * ya((s * s * (o * o) - s * s * (c * c) - o * o * (l * l)) / (s * s * (c * c) + o * o * (l * l))) || 0, d = _ * s * c / o, g = _ * -o * l / s, y = (r + e) / 2 + Ke(v) * d - Ze(v) * g, m = (t + i) / 2 + Ze(v) * d + Ke(v) * g, w = Ts([1, 0], [(l - d) / s, (c - g) / o]), S = [(l - d) / s, (c - g) / o], b = [(-1 * l - d) / s, (-1 * c - g) / o], T = Ts(S, b);
  if (Va(S, b) <= -1 && (T = fe), Va(S, b) >= 1 && (T = 0), T < 0) {
    var C = Math.round(T / fe * 1e6) / 1e6;
    T = fe * 2 + C % 2 * fe;
  }
    ...
    for (var d = 0; d < p; ) {
      ...
      switch (v) {
        ...
        case "t":
          ...
          break;
        case "A":
          m = c[d++], w = c[d++], S = c[d++], b = c[d++], T = c[d++], C = e, M = i, e = c[d++], i = c[d++], l = o.A, bs(C, M, e, i, b, T, m, w, S, l, t);
          break;
        case "a":
          m = c[d++], w = c[d++], S = c[d++], b = c[d++], T = c[d++], C = e, M = i, e += c[d++], i += c[d++], l = o.A, bs(C, M, e, i, b, T, m, w, S, l, t);
          break;
...
function sf(r, t) {
  ...
  return i.buildPath = function(a) {
    ...
    ef(e, a), this.dirtyShape();
  }, i;
}
function bv(r, t) {
  return new af(sf(r, t));
}
function zc(r, t) {
  var e = sf(r, t), i = function(a) {
    N(n, a);
    function n(s) {
...
function of(r, t) {
  t = t || {};
  var e = new K();
  return r.shape && e.setShape(r.shape), e.setStyle(r.style), t.bakeTransform ? ef(e.path, r.getComputedTransform()) : t.toLocal ? e.setLocalTransform(r.getComputedTransform()) : e.copyTransform(r), e.buildPath = r.buildPath, e.applyTransform = e.applyTransform, e.z = r.z, e.z2 = r.z2, e.zlevel = r.zlevel, e;
}
...
var uf = Math.PI, ma = uf * 2, lr = Math.sin, Er = Math.cos, Mv = Math.acos, it = Math.atan2, Ss = Math.abs, me = Math.sqrt, le = Math.max, At = Math.min, bt = 1e-4;
function Pv(r, t, e, i, a, n, s, o) {
  var f = e - r, h = i - t, u = s - a, v = o - n, l = v * f - u * h;
  if (!(l * l < bt)) return l = (u * (t - n) - v * (r - a)) / l, [r + l * f, t + l * h];
}
function Qe(r, t, e, i, a, n, s) {
  var o = r - e, f = t - i, h = (s ? n : -n) / me(o * o + f * f), u = h * f, v = -h * o, l = r + u, c = t + v, p = e + u, _ = i + v, d = (l + p) / 2, g = (c + _) / 2, y = p - l, m = _ - c, w = y * y + m * m, S = a - n, b = l * _ - p * c, T = (m < 0 ? -1 : 1) * me(le(0, S * S * w - b * b)), C = (b * m - y * T) / w, M = (-b * y - m * T) / w, P = (b * m + y * T) / w, L = (-b * y + m * T) / w, R = C - d, A = M - g, x = P - d, E = L - g;
...
function xv(r, t) {
  var e, i = le(t.r, 0), a = le(t.r0 || 0, 0), n = i > 0, s = a > 0;
  if (!(!n && !s)) {
    if (n || (i = a, a = 0), a > i) {
      var o = i;
      i = a, a = o;
    ...
    if (!(isNaN(f) || isNaN(h))) {
      var u = t.cx, v = t.cy, l = !!t.clockwise, c = Ss(h - f), p = c > ma && c % ma;
      if (p > bt && (c = p), !(i > bt)) r.moveTo(u, v);
      else if (c > ma - bt) r.moveTo(u + i * Er(f), v + i * lr(f)), r.arc(u, v, i, f, h, !l), a > bt && (r.moveTo(u + a * Er(h), v + a * lr(h)), r.arc(u, v, a, h, f, l));
      else {
        var _ = void 0, d = void 0, g = void 0, y = void 0, m = void 0, w = void 0, S = void 0, b = void 0, T = void 0, C = void 0, M = void 0, P = void 0, L = void 0, R = void 0, A = void 0, x = void 0, E = i * Er(f), D = i * lr(f), F = a * Er(h), H = a * lr(h), j = c > bt;
        if (j) {
          var V = t.cornerRadius;
          V && (e = Lv(V), _ = e[0], d = e[1], g = e[2], y = e[3]);
          var W = Ss(i - a) / 2;
          if (m = At(W, g), w = At(W, y), S = At(W, _), b = At(W, d), M = T = le(m, w), P = C = le(S, b), (T > bt || C > bt) && (L = i * Er(h), R = i * lr(h), A = a * Er(f), x = a * lr(f), c < uf)) {
            var Y = Pv(E, D, A, x, L, R, F, H);
            if (Y) {
              var et = E - Y[0], tt = D - Y[1], pt = L - Y[0], Bt = R - Y[1], Ht = 1 / lr(Mv((et * pt + tt * Bt) / (me(et * et + tt * tt) * me(pt * pt + Bt * Bt))) / 2), gt = me(Y[0] * Y[0] + Y[1] * Y[1]);
              M = At(T, (i - gt) / (Ht + 1)), P = At(C, (a - gt) / (Ht - 1));
            }
          }
        }
        if (!j) r.moveTo(u + E, v + D);
        else if (M > bt) {
          var Q = At(g, M), q = At(y, M), I = Qe(A, x, E, D, i, Q, l), O = Qe(L, R, F, H, i, q, l);
        ...
        if (!(a > bt) || !j) r.lineTo(u + F, v + H);
        else if (P > bt) {
          var Q = At(_, P), q = At(d, P), I = Qe(F, H, L, R, a, -q, l), O = Qe(E, D, A, x, a, -Q, l);
...
function Iv(r, t, e, i) {
  ...
  if (i) {
    u = [1 / 0, 1 / 0], v = [-1 / 0, -1 / 0];
    for (var l = 0, c = r.length; l < c; l++) Nr(u, u, r[l]), Yr(v, v, r[l]);
    Nr(u, u, i[0]), Yr(v, v, i[1]);
  }
  for (var l = 0, c = r.length; l < c; l++) {
    ...
    nh(n, h, f), zi(n, n, t);
    var _ = xa(p, f), d = xa(p, h), g = _ + d;
    g !== 0 && (_ /= g, d /= g), zi(s, n, -_), zi(o, n, d);
    var y = An([], p, s), m = An([], p, o);
    i && (Yr(y, y, u), Nr(y, y, v), Yr(m, m, u), Nr(m, m, v)), a.push(y), a.push(m);
  }
...
function Cs(r, t, e) {
  ...
  return i != null || a != null ? [(e ? Yn : rt)(r.x1, r.cpx1, r.cpx2, r.x2, t), (e ? Yn : rt)(r.y1, r.cpy1, r.cpy2, r.y2, t)] : [(e ? Gn : at)(r.x1, r.cpx1, r.x2, t), (e ? Gn : at)(r.y1, r.cpy1, r.y2, t)];
}
var Hv = function(r) {
  N(t, r);
  function t(e) {
  ...
  return t.prototype.getDefaultStyle = function() {
    ...
    l !== 0 && (e.moveTo(a, n), u == null || v == null ? (l < 1 && (li(a, f, s, l, ft), f = ft[1], s = ft[2], li(n, h, o, l, ft), h = ft[1], o = ft[2]), e.quadraticCurveTo(f, h, s, o)) : (l < 1 && (Jt(a, f, u, s, l, ft), f = ft[1], u = ft[2], s = ft[3], Jt(n, h, v, o, l, ft), h = ft[1], v = ft[2], o = ft[3]), e.bezierCurveTo(f, h, u, v, s, o)));
  }, t.prototype.pointAt = function(e) {
    return Cs(this.shape, e, false);
  }, t.prototype.tangentAt = function(e) {
    var i = Cs(this.shape, e, true);
    return fh(i, i);
  }, t;
}(K);
...
var Yv = function(r) {
  ...
  return t;
}(df), cr = [0, 0], dr = [0, 0], Je = new k(), je = new k(), Yc = function() {
  function r(t, e) {
  ...
  return r.prototype.fromBoundingRect = function(t, e) {
    ...
    var i = true, a = !e;
    return Je.set(1 / 0, 1 / 0), je.set(0, 0), !this._intersectCheckOneSide(this, t, Je, je, a, 1) && (i = false, a) || !this._intersectCheckOneSide(t, this, Je, je, a, -1) && (i = false, a) || a || k.copy(e, i ? Je : je), i;
...
}(De), Wv = Math.round(Math.random() * 9), qv = typeof Object.defineProperty == "function", Xc = function() {
  function r() {
...
function Wr(r, t, e) {
  ...
  return (r[a] || ti(o[i]) || ti(r.style[i])) - (ti(o[n]) || 0) - (ti(o[s]) || 0) | 0;
}
function Kv(r, t) {
  return !r || r === "solid" || !(t > 0) ? null : r === "dashed" ? [4 * t, 2 * t] : r === "dotted" ? [t] : de(r) ? [r] : Zr(r) ? r : null;
}
function _n(r) {
...
function Qa(r, t, e) {
  var i = pn(t.image, t.__image, e);
  if (Fi(i)) {
    var a = r.createPattern(i, t.repeat || "repeat");
    if (typeof DOMMatrix == "function" && a && a.setTransform) {
      var n = new DOMMatrix();
      n.translateSelf(t.x || 0, t.y || 0), n.rotateSelf(0, 0, (t.rotation || 0) * ii), n.scaleSelf(t.scaleX || 1, t.scaleY || 1), a.setTransform(n);
    }
    return a;
  }
}
function Jv(r, t, e, i) {
  var a, n = _i(e), s = yi(e), o = e.strokePercent, f = o < 1, h = !t.path;
  ...
  if (!i) {
    ...
    (p || _) && (b = t.getBoundingRect()), p && (y = v ? Ka(r, l, b) : t.__canvasFillGradient, t.__canvasFillGradient = y), _ && (m = v ? Ka(r, c, b) : t.__canvasStrokeGradient, t.__canvasStrokeGradient = m), d && (w = v || !t.__canvasFillPattern ? Qa(r, l, t) : t.__canvasFillPattern, t.__canvasFillPattern = w), g && (S = v || !t.__canvasStrokePattern ? Qa(r, c, t) : t.__canvasStrokePattern, t.__canvasStrokePattern = w), p ? r.fillStyle = y : d && (w ? r.fillStyle = w : s = false), _ ? r.strokeStyle = m : g && (S ? r.strokeStyle = S : n = false);
  }
  var T = t.getGlobalScale();
  u.setScale(T[0], T[1], t.segmentIgnoreThreshold);
  var C, M;
  r.setLineDash && e.lineDash && (a = _n(t), C = a[0], M = a[1]);
  var P = true;
  (h || v & Or) && (u.setDPR(r.dpr), f ? u.setContext(null) : (u.setContext(r), P = false), u.reset(), t.buildPath(u, t.shape, i), u.toStatic(), t.pathUpdated()), P && u.rebuildPath(r, f ? o : 1), C && (r.setLineDash(C), r.lineDashOffset = M), i || (e.strokeFirst ? (n && Ls(r, e), s && Ps(r, e)) : (s && Ps(r, e), n && Ls(r, e))), C && r.setLineDash([]);
}
function jv(r, t, e) {
  var i = t.__image = pn(e.image, t.__image, t, t.onload);
  if (!(!i || !Fi(i))) {
...
function tl(r, t, e) {
  ...
  if (a != null && (a += ""), a) {
    ...
    r.setLineDash && e.lineDash && (i = _n(t), n = i[0], s = i[1]), n && (r.setLineDash(n), r.lineDashOffset = s), e.strokeFirst ? (_i(e) && r.strokeText(a, e.x, e.y), yi(e) && r.fillText(a, e.x, e.y)) : (yi(e) && r.fillText(a, e.x, e.y), _i(e) && r.strokeText(a, e.x, e.y)), n && r.setLineDash([]);
  }
}
var xs = ["shadowBlur", "shadowOffsetX", "shadowOffsetY"], Rs = [["lineCap", "butt"], ["lineJoin", "miter"], ["miterLimit", 10]];
function pf(r, t, e, i, a) {
  var n = false;
...
function As(r, t, e, i, a) {
  var n = Pe(t, a.inHover), s = i ? null : e && Pe(e, a.inHover) || {};
  if (n === s) return false;
  var o = pf(r, n, s, i, a);
  if ((i || n.fill !== s.fill) && (o || (vt(r, a), o = true), Ms(n.fill) && (r.fillStyle = n.fill)), (i || n.stroke !== s.stroke) && (o || (vt(r, a), o = true), Ms(n.stroke) && (r.strokeStyle = n.stroke)), (i || n.opacity !== s.opacity) && (o || (vt(r, a), o = true), r.globalAlpha = n.opacity == null ? 1 : n.opacity), t.hasStroke()) {
    var f = n.lineWidth, h = f / (n.strokeNoScale && t.getLineScale ? t.getLineScale() : 1);
    r.lineWidth !== h && (o || (vt(r, a), o = true), r.lineWidth = h);
  }
  for (var u = 0; u < Rs.length; u++) {
    var v = Rs[u], l = v[0];
...
function rl(r, t, e, i, a) {
  return pf(r, Pe(t, a.inHover), e && Pe(e, a.inHover), i, a);
}
function gf(r, t) {
...
function el(r, t, e) {
  for (var i = false, a = 0; a < r.length; a++) {
    var n = r[a];
    i = i || n.isZeroArea(), gf(t, n), t.beginPath(), n.buildPath(t, n.shape), t.clip();
  }
  e.allClipped = i;
}
function il(r, t) {
...
function Tr(r, t, e, i) {
  ...
  if (!t.shouldBePainted(e.viewWidth, e.viewHeight, false, false)) {
    t.__dirty &= ~ct, t.__isRendered = false;
    return;
  }
  ...
  o || il(a, h.transform) ? (vt(r, e), gf(r, t)) : u || vt(r, e);
  var v = Pe(t, e.inHover);
  t instanceof K ? (e.lastDrawType !== Ds && (f = true, e.lastDrawType = Ds), As(r, t, h, f, e), (!u || !e.batchFill && !e.batchStroke) && r.beginPath(), Jv(r, t, v, u), u && (e.batchFill = v.fill || "", e.batchStroke = v.stroke || "")) : t instanceof Kr ? (e.lastDrawType !== Es && (f = true, e.lastDrawType = Es), As(r, t, h, f, e), tl(r, t, v)) : t instanceof te ? (e.lastDrawType !== Is && (f = true, e.lastDrawType = Is), rl(r, t, h, f, e), jv(r, t, v)) : t.getTemporalDisplayables && (e.lastDrawType !== Fs && (f = true, e.lastDrawType = Fs), sl(r, t, e)), u && i && vt(r, e), t.innerAfterBrush(), t.afterBrush && t.afterBrush(), e.prevEl = t, t.__dirty = 0, t.__isRendered = true;
}
function sl(r, t, e) {
...
function Uc(r, t, e) {
  ...
  var o = r[0];
  return (!Os(a[0], o[0]) || !Os(a[1], o[1])) && (i += Gt(a[0], a[1], o[0], o[1], t, e)), i !== 0;
}
var wa = Math.sin, Ta = Math.cos, _f = Math.PI, pr = Math.PI * 2, fl = 180 / _f, yf = function() {
  function r() {
  }
  return r.prototype.reset = function(t) {
    ...
    l ? p = true : Zt(v) ? p = false : p = c >= _f == !!u;
    var _ = t + i * Ta(s), d = e + a * wa(s);
    this._start && this._add("M", _, d);
    var g = Math.round(n * fl);
    if (l) {
      var y = 1 / this._p, m = (u ? 1 : -1) * (pr - y);
      this._add("A", i, a, g, 1, +u, t + i * Ta(s + m), e + a * wa(s + m)), y > 0.01 && this._add("A", i, a, g, 0, +u, _, d);
    } else {
      var w = t + i * Ta(o), S = e + a * wa(o);
...
var Ja = ["lineCap", "miterLimit", "lineJoin"], ll = Z(Ja, function(r) {
...
var mf = "http://www.w3.org/2000/svg", wf = "http://www.w3.org/1999/xlink", dl = "http://www.w3.org/2000/xmlns/", pl = "http://www.w3.org/XML/1998/namespace", ks = "ecmeta_";
function Tf(r) {
  return document.createElementNS(mf, r);
}
...
` : "";
  function i(a) {
    ...
    return gl(s, o) + (s !== "style" ? yh(f) : f || "") + (n ? "" + e + Z(n, function(h) {
      return i(h);
    }).join(e) + e : "") + _l(s);
  }
  return i(r);
...
function Bs(r, t, e, i) {
  return J("svg", "root", { width: r, height: t, xmlns: mf, "xmlns:xlink": wf, version: "1.1", baseProfile: "full", viewBox: i ? "0 0 " + r + " " + t : false }, e);
}
var ml = 0;
function bf() {
  return ml++;
}
var Hs = { cubicIn: "0.32,0,0.67,0", cubicOut: "0.33,1,0.68,1", cubicInOut: "0.65,0,0.35,1", quadraticIn: "0.11,0,0.5,0", quadraticOut: "0.5,1,0.89,1", quadraticInOut: "0.45,0,0.55,1", quarticIn: "0.5,0,0.75,0", quarticOut: "0.25,1,0.5,1", quarticInOut: "0.76,0,0.24,1", quinticIn: "0.64,0,0.78,0", quinticOut: "0.22,1,0.36,1", quinticInOut: "0.83,0,0.17,1", sinusoidalIn: "0.12,0,0.39,0", sinusoidalOut: "0.61,1,0.88,1", sinusoidalInOut: "0.37,0,0.63,1", exponentialIn: "0.7,0,0.84,0", exponentialOut: "0.16,1,0.3,1", exponentialInOut: "0.87,0,0.13,1", circularIn: "0.55,0,1,0.45", circularOut: "0,0.55,0.45,1", circularInOut: "0.85,0,0.15,1" }, _r = "transform-origin";
function wl(r, t, e) {
  var i = z({}, r.shape);
  z(i, t), r.buildPath(e, i);
  var a = new yf();
  return a.reset(Yo(r)), e.rebuildPath(a, 1), a.generateStr(), a.getStr();
}
function Tl(r, t) {
...
function zs(r) {
  return kt(r) ? Hs[r] ? "cubic-bezier(" + Hs[r] + ")" : vn(r) ? r : "" : "";
}
function ki(r, t, e, i) {
  ...
  for (var f = {}, h = 0; h < n; h++) {
    var u = a[h], v = [u.getMaxTime() / 1e3 + "s"], l = zs(u.getClip().easing), c = u.getDelay();
  ...
  function _(y) {
    ...
    function M(gt, Q, q) {
      for (var I = gt.getTracks(), O = gt.getMaxTime(), zt = 0; zt < I.length; zt++) {
        var ot = I[zt];
        if (ot.needsAnimate()) {
          var Cn = ot.keyframes, Ie = ot.propName;
          if (q && (Ie = q(Ie)), Ie) for (var Hi = 0; Hi < Cn.length; Hi++) {
            var Ee = Cn[Hi], Fe = Math.round(Ee.time / O * 100) + "%", Mn = zs(Ee.easing), Pn = Ee.rawValue;
            (kt(Pn) || de(Pn)) && (Q[Fe] = Q[Fe] || {}, Q[Fe][Ie] = Ee.rawValue, Mn && (Q[Fe][C] = Mn));
          }
        }
      }
    }
...
function Cl(r, t, e) {
  if (!r.ignore) if (r.isSilent()) {
    ...
    n && (i.fill = n), a.stroke && (i.stroke = a.stroke), h && (i["stroke-width"] = h), Ns(i, t, e);
  }
}
function Ns(r, t, e, i) {
  var a = JSON.stringify(r), n = e.cssStyleCache[a];
  n || (n = e.zrId + "-cls-" + bf(), e.cssStyleCache[a] = n, e.cssNodes["." + n + ":hover"] = r), t.class = t.class ? t.class + " " + n : n;
}
var Le = Math.round;
function Cf(r) {
  return r && kt(r.src);
...
function Mf(r) {
  return r && Re(r.toDataURL);
}
function wn(r, t, e, i) {
  cl(function(a, n) {
    var s = a === "fill" || a === "stroke";
    s && No(n) ? Lf(t, r, a, i) : s && ln(n) ? xf(e, r, a, i) : r[a] = n, s && i.ssr && n === "none" && (r["pointer-events"] = "visible");
  }, t, e, false), Dl(e, r, i);
}
function Tn(r, t) {
  var e = xu(t);
  e && (e.each(function(i, a) {
    i != null && (r[(ks + a).toLowerCase()] = i + "");
  }), t.isSilent() && (r[ks + "silent"] = "true"));
}
function Ys(r) {
...
function bn(r, t, e) {
  if (t && !(Ml(t) && Ys(t))) {
    var i = 1e4;
    r.transform = Ys(t) ? "translate(" + Le(t[4] * i) / i + " " + Le(t[5] * i) / i + ")" : Kh(t);
  }
}
function Gs(r, t, e) {
  for (var i = r.points, a = [], n = 0; n < i.length; n++) a.push(Le(i[n][0] * e) / e), a.push(Le(i[n][1] * e) / e);
  t.points = a.join(" ");
}
function Xs(r) {
  return !r.smooth;
...
function Pl(r) {
  ...
  return function(e, i, a) {
    for (var n = 0; n < t.length; n++) {
      var s = t[n], o = e[s[0]];
      o != null && (i[s[1]] = Le(o * a) / a);
    }
  };
}
var Ll = { circle: [Pl(["cx", "cy", "r"])], polyline: [Gs, Xs], polygon: [Gs, Xs] };
function xl(r) {
  for (var t = r.animators, e = 0; e < t.length; e++) if (t[e].targetName === "shape") return true;
  return false;
}
function Pf(r, t) {
  var e = r.style, i = r.shape, a = Ll[r.type], n = {}, s = t.animation, o = "path", f = r.style.strokePercent, h = t.compress && Yo(r) || 4;
  if (a && !t.willUpdate && !(a[1] && !a[1](i)) && !(s && xl(r)) && !(f < 1)) {
    ...
    (p.__svgPathVersion !== c || !_ || f !== p.__svgPathStrokePercent) && (_ || (_ = p.__svgPathBuilder = new yf()), _.reset(h), l.rebuildPath(_, f), _.generateStr(), p.__svgPathVersion = c, p.__svgPathStrokePercent = f), n.d = _.getStr();
  }
  return bn(n, r.transform), wn(n, e, r, t), Tn(n, r), t.animation && ki(r, n, t), t.emphasis && Cl(r, n, t), J(o, r.id + "", n);
}
function Rl(r, t) {
  var e = r.style, i = e.image;
  if (i && !kt(i) && (Cf(i) ? i = i.src : Mf(i) && (i = i.toDataURL())), !!i) {
    var a = e.x || 0, n = e.y || 0, s = e.width, o = e.height, f = { href: i, width: s, height: o };
    return a && (f.x = a), n && (f.y = n), bn(f, r.transform), wn(f, e, r, t), Tn(f, r), t.animation && ki(r, f, t), J("image", r.id + "", f);
  }
}
function Al(r, t) {
  var e = r.style, i = e.text;
  if (i != null && (i += ""), !(!i || isNaN(e.x) || isNaN(e.y))) {
    var a = e.font || Qt, n = e.x || 0, s = Jh(e.y || 0, Ii(a), e.textBaseline), o = Qh[e.textAlign] || e.textAlign, f = { "dominant-baseline": "central", "text-anchor": o };
    if (rf(e)) {
      var h = "", u = e.fontStyle, v = tf(e.fontSize);
      if (!parseFloat(v)) return;
      var l = e.fontFamily || lo, c = e.fontWeight;
      h += "font-size:" + v + ";font-family:" + l + ";", u && u !== "normal" && (h += "font-style:" + u + ";"), c && c !== "normal" && (h += "font-weight:" + c + ";"), f.style = h;
    } else f.style = "font: " + a;
    return i.match(/\s/) && (f["xml:space"] = "preserve"), n && (f.x = n), s && (f.y = s), bn(f, r.transform), wn(f, e, r, t), Tn(f, r), t.animation && ki(r, f, t), J("text", r.id + "", f, void 0, i);
  }
}
function Us(r, t) {
  if (r instanceof K) return Pf(r, t);
  if (r instanceof te) return Rl(r, t);
  if (r instanceof Kr) return Al(r, t);
}
function Dl(r, t, e) {
  var i = r.style;
  if (jh(i)) {
    var a = tu(r), n = e.shadowCache, s = n[a];
    if (!s) {
      var o = r.getGlobalScale(), f = o[0], h = o[1];
      if (!f || !h) return;
      var u = i.shadowOffsetX || 0, v = i.shadowOffsetY || 0, l = i.shadowBlur, c = be(i.shadowColor), p = c.opacity, _ = c.color, d = l / 2 / f, g = l / 2 / h, y = d + " " + g;
...
function Lf(r, t, e, i) {
  ...
  if (Ho(a)) n = "linearGradient", s.x1 = a.x, s.y1 = a.y, s.x2 = a.x2, s.y2 = a.y2;
  else if (zo(a)) n = "radialGradient", s.cx = $(a.x, 0.5), s.cy = $(a.y, 0.5), s.r = $(a.r, 0.5);
  else return;
  for (var o = a.colorStops, f = [], h = 0, u = o.length; h < u; ++h) {
    var v = Oa(o[h].offset) * 100 + "%", l = o[h].color, c = be(l), p = c.color, _ = c.opacity, d = { offset: v };
    d["stop-color"] = p, _ < 1 && (d["stop-opacity"] = _), f.push(J("stop", h + "", d));
  }
  var g = J(n, "", s, f), y = mn(g), m = i.gradientCache, w = m[y];
  w || (w = i.zrId + "-g" + i.gradientIdx++, m[y] = w, s.id = w, i.defs[w] = J(n, w, s, f)), t[e] = Di(w);
}
function xf(r, t, e, i) {
  ...
  if (Bo(a)) {
    ...
    if (kt(_) ? p = _ : Cf(_) ? p = _.src : Mf(_) && (p = _.toDataURL()), typeof Image > "u") {
  ...
  if (v) {
    ...
    var b = J("pattern", "", s, [v]), T = mn(b), C = i.patternCache, M = C[T];
    M || (M = i.zrId + "-p" + i.patternIdx++, C[T] = M, s.id = M, b = i.defs[M] = J("pattern", M, s, [v])), t[e] = Di(M);
  }
}
function Il(r, t, e) {
  ...
  if (!n) {
    ...
    var s = { id: n };
    i[r.id] = n, a[n] = J("clipPath", n, s, [Pf(r, e)]);
  }
  t["clip-path"] = Di(n);
}
function Ws(r) {
...
function xe(r) {
  ...
  if (It(i)) {
    var a = r.elm = Tf(i);
    if (Sn(Fl, r), Zr(e)) for (t = 0; t < e.length; ++t) {
      var n = e[t];
      n != null && $s(a, xe(n));
    }
    else It(r.text) && !Xt(r.text) && $s(a, Ws(r.text));
  } else r.elm = Ws(r.text);
  return r.elm;
}
function Df(r, t, e, i, a) {
  for (; i <= a; ++i) {
    var n = e[i];
    n != null && mr(r, xe(n), t);
  }
...
function Sn(r, t) {
  ...
  if (a !== n) {
    for (e in n) {
      var s = n[e], o = a[e];
      o !== s && (s === true ? i.setAttribute(e, "") : s === false ? i.removeAttribute(e) : e === "style" ? i.style.cssText = s : e.charCodeAt(0) !== El ? i.setAttribute(e, s) : e === "xmlns:xlink" || e === "xmlns" ? i.setAttributeNS(dl, e, s) : e.charCodeAt(3) === Vs ? i.setAttributeNS(pl, e, s) : e.charCodeAt(5) === Vs ? i.setAttributeNS(wf, e, s) : i.setAttribute(e, s));
    }
    for (e in a) e in n || i.removeAttribute(e);
  }
}
function kl(r, t, e) {
  for (var i = 0, a = 0, n = t.length - 1, s = t[0], o = t[n], f = e.length - 1, h = e[0], u = e[f], v, l, c, p; i <= n && a <= f; ) s == null ? s = t[++i] : o == null ? o = t[--n] : h == null ? h = e[++a] : u == null ? u = e[--f] : ce(s, h) ? (Br(s, h), s = t[++i], h = e[++a]) : ce(o, u) ? (Br(o, u), o = t[--n], u = e[--f]) : ce(s, u) ? (Br(s, u), mr(r, s.elm, Af(o.elm)), s = t[++i], u = e[--f]) : ce(o, h) ? (Br(o, h), mr(r, o.elm, s.elm), o = t[--n], h = e[++a]) : (tn(v) && (v = Ol(t, i, n)), l = v[h.key], tn(l) ? mr(r, xe(h), s.elm) : (c = t[l], c.tag !== h.tag ? mr(r, xe(h), s.elm) : (Br(c, h), t[l] = void 0, mr(r, c.elm, s.elm))), h = e[++a]);
  (i <= n || a <= f) && (i > n ? (p = e[f + 1] == null ? null : e[f + 1].elm, Df(r, p, e, a, f)) : mi(r, t, i, n));
}
function Br(r, t) {
  var e = t.elm = r.elm, i = r.children, a = t.children;
  r !== t && (Sn(r, t), tn(t.text) ? It(i) && It(a) ? i !== a && kl(e, i, a) : It(a) ? (It(r.text) && ba(e, ""), Df(e, null, a, 0, a.length - 1)) : It(i) ? mi(e, i, 0, i.length - 1) : It(r.text) && ba(e, "") : r.text !== t.text && (It(i) && mi(e, i, 0, i.length - 1), ba(e, t.text)));
}
function Bl(r, t) {
  if (ce(r, t)) Br(r, t);
  else {
    var e = r.elm, i = Rf(e);
    xe(t), i !== null && (mr(i, t.elm, Af(e)), mi(i, [r], 0, 0));
  }
  return t;
}
var Hl = 0, Wc = function() {
  function r(t, e, i) {
    if (this.type = "svg", this.refreshHover = Zs(), this.configLayer = Zs(), this.storage = e, this._opts = i = z({}, i), this.root = t, this._id = "zr" + Hl++, this._oldVNode = Bs(i.width, i.height), t && !i.ssr) {
      var a = this._viewport = document.createElement("div");
      a.style.cssText = "position:relative;overflow:hidden";
      var n = this._svgDom = this._oldVNode.elm = Tf("svg");
      Sn(null, this._oldVNode), a.appendChild(n), t.appendChild(a);
    }
  ...
  return r.prototype.getType = function() {
    ...
    return Bs(i, a, s, t.useViewBox);
  }, r.prototype.renderToString = function(t) {
    return t = t || {}, mn(this.renderToVNode({ animation: $(t.cssAnimation, true), emphasis: $(t.cssEmphasis, true), willUpdate: false, compress: true, useViewBox: $(t.useViewBox, true) }), { newline: true });
  }, r.prototype.setBackgroundColor = function(t) {
    ...
    if (t != null && (i.width = t), e != null && (i.height = e), a && n && (n.style.display = "none", t = Wr(a, 0, i), e = Wr(a, 1, i), n.style.display = ""), this._width !== t || this._height !== e) {
      if (this._width = t, this._height = e, n) {
        var s = n.style;
        s.width = t + "px", s.height = e + "px";
      }
      if (ln(this._backgroundColor)) this.refresh();
      else {
        var o = this._svgDom;
    ...
    return t ? (e = eu(e), e && i + "base64," + e) : i + "charset=UTF-8," + encodeURIComponent(e);
  }, r;
}();
function Zs(r) {
  return function() {
...
function zl(r, t, e, i) {
  var a;
  if (e && e !== "none") if (a = J("rect", "bg", { width: r, height: t, x: "0", y: "0" }), No(e)) Lf({ fill: e }, a.attrs, "fill", i);
  else if (ln(e)) xf({ style: { fill: e }, dirty: br, getBoundingRect: function() {
    return { width: r, height: t };
  } }, a.attrs, "fill", i);
  else {
    var n = be(e), s = n.color, o = n.opacity;
    a.attrs.fill = s, o < 1 && (a.attrs["fill-opacity"] = o);
  }
  return a;
}
function Ks(r, t, e) {
  var i = Mi.createCanvas(), a = t.getWidth(), n = t.getHeight(), s = i.style;
...
var Sa = function(r) {
  ...
  function t(e, i, a) {
    ...
    var s;
    a = a || pi, typeof e == "string" ? s = Ks(e, i, a) : Xt(e) && (s = e, e = s.id), n.id = e, n.dom = s;
    var o = s.style;
    return o && (To(s), s.onselectstart = function() {
      return false;
  ...
  return t.prototype.getElementCount = function() {
    ...
    var e = this.dpr;
    this.domBack = Ks("back-" + this.id, this.painter, e), this.ctxBack = this.domBack.getContext("2d"), e !== 1 && this.ctxBack.scale(e, e);
    ...
    for (var v = this.__startIndex; v < this.__endIndex; ++v) {
      var l = e[v];
      if (l) {
        var c = l.shouldBePainted(a, n, true, true), p = l.__isRendered && (l.__dirty & ct || !c) ? l.getPrevPaintRect() : null;
        p && u(p);
        var _ = c && (l.__dirty & ct || !l.__isRendered) ? l.getPaintRect() : null;
        _ && u(_);
      }
    }
    ...
    function p(_, d, g, y) {
      if (s.clearRect(_, d, g, y), i && i !== "transparent") {
        ...
        if (xi(i)) {
          ...
          m = w && i.__canvasGradient || Ka(s, i, { x: 0, y: 0, width: g, height: y }), i.__canvasGradient = m, i.__width = g, i.__height = y;
        } else Jf(i) && (i.scaleX = i.scaleX || v, i.scaleY = i.scaleY || v, m = Qa(s, i, { dirty: function() {
...
}(jr), Qs = 1e5, gr = 314159, ri = 0.01, Nl = 1e-3;
function Yl(r) {
...
var qc = function() {
  function r(t, e, i, a) {
    ...
    this._opts = i = z({}, i || {}), this.dpr = i.devicePixelRatio || pi, this._singleCanvas = n, this.root = t;
    var s = t.style;
    s && (To(t), t.innerHTML = ""), this.storage = e;
  ...
  return r.prototype.getType = function() {
    ...
    if (i && i.clear(), !!e) {
      for (var a = { inHover: true, viewWidth: this._width, viewHeight: this._height }, n, s = 0; s < e; s++) {
        var o = t[s];
        o.__inHover && (i || (i = this._hoverlayer = this.getLayer(Qs)), n || (n = i.ctx, n.save()), Tr(n, o, a, s === e - 1));
      }
      n && n.restore();
    }
  }, r.prototype.getHoverLayer = function() {
    return this.getLayer(Qs);
    ...
    return i || (i = new Sa("zr_" + t, this, this.dpr), i.zlevel = t, i.__builtin__ = true, this._layerConfig[t] ? Hr(i, this._layerConfig[t], true) : this._layerConfig[t - ri] && Hr(i, this._layerConfig[t - ri], true), e && (i.virtual = e), this.insertLayer(t, i), i.initContext()), i;
    ...
    for (f = 0; f < t.length; f++) {
      ...
      o !== h && (o = h, s = 0), a.incremental ? (u = this.getLayer(h + Nl, this._needsManuallyCompositing), u.incremental = true, s = 1) : u = this.getLayer(h + (s > 0 ? ri : 0), this._needsManuallyCompositing), u.__builtin__ || hn("ZLevel " + h + " has been used by unkown layer " + u.id), u !== n && (u.__used = true, u.__startIndex !== f && (u.__dirty = true), u.__startIndex = f, u.incremental ? u.__drawIndex = -1 : u.__drawIndex = f, e(f), n = u), a.__dirty & ct && !a.__inHover && (u.__dirty = true, u.incremental && u.__drawIndex < 0 && (u.__drawIndex = f));
    }
    ...
    a && (a.dom.parentNode.removeChild(a.dom), delete e[t], i.splice(Et(i, t), 1));
  }, r.prototype.resize = function(t, e) {
    if (this._domRoot.style) {
      var i = this._domRoot;
      i.style.display = "none";
      var a = this._opts, n = this.root;
      if (t != null && (a.width = t), e != null && (a.height = e), t = Wr(n, 0, a), e = Wr(n, 1, a), i.style.display = "", this._width !== t || e !== this._height) {
    ...
    var e = new Sa("image", this, t.pixelRatio || this.dpr);
...
var Ca, wi = { fill: "fill", stroke: "stroke", "stroke-width": "lineWidth", opacity: "opacity", "fill-opacity": "fillOpacity", "stroke-opacity": "strokeOpacity", "stroke-dasharray": "lineDash", "stroke-dashoffset": "lineDashOffset", "stroke-linecap": "lineCap", "stroke-linejoin": "lineJoin", "stroke-miterlimit": "miterLimit", "font-family": "fontFamily", "font-size": "fontSize", "font-style": "fontStyle", "font-weight": "fontWeight", "text-anchor": "textAlign", visibility: "visibility", display: "display" }, Js = G(wi), Ti = { "alignment-baseline": "textBaseline", "stop-color": "stopColor" }, js = G(Ti), Ul = function() {
  function r() {
  ...
  return r.prototype.parse = function(t, e) {
    ...
    return !e.ignoreRootClip && o != null && f != null && a.setClipPath(new Me({ shape: { x: 0, y: 0, width: o, height: f } })), { root: a, width: o, height: f, viewBoxRect: u, viewBoxTransform: v, named: n };
    ...
    var i = new Kr({ style: { text: t.textContent }, silent: true, x: this._textX || 0, y: this._textY || 0 });
    _t(e, i), lt(t, i, this._defsUsePending, false, false), Wl(i, e);
    ...
    Ca = { g: function(t, e) {
      var i = new yr();
      return _t(e, i), lt(t, i, this._defsUsePending, false, false), i;
    }, rect: function(t, e) {
      var i = new Me();
      return _t(e, i), lt(t, i, this._defsUsePending, false, false), i.setShape({ x: parseFloat(t.getAttribute("x") || "0"), y: parseFloat(t.getAttribute("y") || "0"), width: parseFloat(t.getAttribute("width") || "0"), height: parseFloat(t.getAttribute("height") || "0") }), i.silent = true, i;
    }, circle: function(t, e) {
      var i = new ff();
      return _t(e, i), lt(t, i, this._defsUsePending, false, false), i.setShape({ cx: parseFloat(t.getAttribute("cx") || "0"), cy: parseFloat(t.getAttribute("cy") || "0"), r: parseFloat(t.getAttribute("r") || "0") }), i.silent = true, i;
    }, line: function(t, e) {
      var i = new cf();
      return _t(e, i), lt(t, i, this._defsUsePending, false, false), i.setShape({ x1: parseFloat(t.getAttribute("x1") || "0"), y1: parseFloat(t.getAttribute("y1") || "0"), x2: parseFloat(t.getAttribute("x2") || "0"), y2: parseFloat(t.getAttribute("y2") || "0") }), i.silent = true, i;
    }, ellipse: function(t, e) {
      var i = new hf();
      return _t(e, i), lt(t, i, this._defsUsePending, false, false), i.setShape({ cx: parseFloat(t.getAttribute("cx") || "0"), cy: parseFloat(t.getAttribute("cy") || "0"), rx: parseFloat(t.getAttribute("rx") || "0"), ry: parseFloat(t.getAttribute("ry") || "0") }), i.silent = true, i;
    }, polygon: function(t, e) {
      var i = t.getAttribute("points"), a;
      i && (a = io(i));
      var n = new gn({ shape: { points: a || [] }, silent: true });
      return _t(e, n), lt(t, n, this._defsUsePending, false, false), n;
    }, polyline: function(t, e) {
      var i = t.getAttribute("points"), a;
      i && (a = io(i));
      var n = new lf({ shape: { points: a || [] }, silent: true });
      return _t(e, n), lt(t, n, this._defsUsePending, false, false), n;
    }, image: function(t, e) {
      var i = new te();
      return _t(e, i), lt(t, i, this._defsUsePending, false, false), i.setStyle({ image: t.getAttribute("xlink:href") || t.getAttribute("href"), x: +t.getAttribute("x"), y: +t.getAttribute("y"), width: +t.getAttribute("width"), height: +t.getAttribute("height") }), i.silent = true, i;
    }, text: function(t, e) {
      ...
      var o = new yr();
      return _t(e, o), lt(t, o, this._defsUsePending, false, true), o;
    }, tspan: function(t, e) {
      ...
      return _t(e, o), lt(t, o, this._defsUsePending, false, true), this._textX += parseFloat(n), this._textY += parseFloat(s), o;
    }, path: function(t, e) {
      var i = t.getAttribute("d") || "", a = bv(i);
      return _t(e, a), lt(t, a, this._defsUsePending, false, false), a.silent = true, a;
    } };
  }(), r;
}(), to = { lineargradient: function(r) {
...
function io(r) {
  for (var t = Bi(r), e = [], i = 0; i < t.length; i += 2) {
...
function lt(r, t, e, i, a) {
  ...
  r.nodeType === 1 && (Kl(r, t), If(r, s, o), i || Ql(r, s, o)), n.style = n.style || {}, s.fill != null && (n.style.fill = ao(n, "fill", s.fill, e)), s.stroke != null && (n.style.stroke = ao(n, "stroke", s.stroke, e)), nt(["lineWidth", "opacity", "fillOpacity", "strokeOpacity", "miterLimit", "fontSize"], function(f) {
  ...
  }), a && (n.__selfStyle = o), s.lineDash && (n.style.lineDash = Z(Bi(s.lineDash), function(f) {
    return parseFloat(f);
...
var Zl = /(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.eE,]*)\)/g, Ma = Math.PI / 180;
function Kl(r, t) {
  ...
  if (e) {
    ...
    for (var n = i.length - 1; n > 0; n -= 2) {
      var s = i[n], o = i[n - 1], f = Bi(s);
      switch (a = a || Sr(), o) {
        case "translate":
          Ia(a, a, [parseFloat(f[0]), parseFloat(f[1] || "0")]);
          break;
        case "scale":
          Mo(a, a, [parseFloat(f[0]), parseFloat(f[1] || f[0])]);
          break;
        case "rotate":
          Co(a, a, -parseFloat(f[0]) * Ma, [parseFloat(f[1] || "0"), parseFloat(f[2] || "0")]);
          break;
        case "skewX":
          var h = Math.tan(parseFloat(f[0]) * Ma);
          _e(a, [1, 0, h, 1, 0, 0], a);
          break;
        case "skewY":
          var u = Math.tan(parseFloat(f[0]) * Ma);
          _e(a, [1, u, 0, 1, 0, 0], a);
          break;
        case "matrix":
...
function If(r, t, e) {
  ...
  if (i) {
    no.lastIndex = 0;
    for (var a; (a = no.exec(i)) != null; ) {
      var n = a[1], s = hi(wi, n) ? wi[n] : null;
      s && (t[s] = a[2]);
      var o = hi(Ti, n) ? Ti[n] : null;
      o && (e[o] = a[2]);
    }
  }
}
...
function rn(r) {
  ...
  function u(A, x, E, D) {
    qr(A, E) && qr(x, D) || a.push(A, x, E, D, E, D);
  }
  function v(A, x, E, D, F, H) {
    var j = Math.abs(x - A), V = Math.tan(j / 4) * 4 / 3, W = x < A ? -1 : 1, Y = Math.cos(A), et = Math.sin(A), tt = Math.cos(x), pt = Math.sin(x), Bt = Y * F + E, Ht = et * H + D, gt = tt * F + E, Q = pt * H + D, q = F * V * W, I = H * V * W;
    a.push(Bt - q * et, Ht + I * Y, gt + q * pt, Q - I * tt, gt, Q);
  }
  for (var l, c, p, _, d = 0; d < e; ) {
    var g = t[d++], y = d === 1;
    switch (y && (n = t[d], s = t[d + 1], o = n, f = s, (g === Dt.L || g === Dt.C || g === Dt.Q) && (a = [o, f])), g) {
      case Dt.M:
...
function en(r, t, e, i, a, n, s, o, f, h) {
  if (qr(r, e) && qr(t, i) && qr(a, s) && qr(n, o)) {
    f.push(s, o);
    return;
  }
  ...
  var M = [], P = [];
  Jt(r, e, a, s, 0.5, M), Jt(t, i, n, o, 0.5, P), en(M[0], P[0], M[1], P[1], M[2], P[2], M[3], P[3], f, h), en(M[4], P[4], M[5], P[5], M[6], P[6], M[7], P[7], f, h);
}
function jl(r, t) {
  var e = rn(r), i = [];
  t = t || 1;
  for (var a = 0; a < e.length; a++) {
    ...
    for (var h = 2; h < n.length; ) {
      ...
      en(o, f, u, v, l, c, p, _, s, t), o = p, f = _;
    }
    i.push(s);
  }
  return i;
...
function so(r, t, e) {
  for (var i = r.r0, a = r.r, n = r.startAngle, s = r.endAngle, o = Math.abs(s - n), f = o * a, h = a - i, u = f > Math.abs(h), v = Ef([f, h], u ? 0 : 1, t), l = (u ? o : h) / v.length, c = 0; c < v.length; c++) for (var p = (u ? h : o) / v[c], _ = 0; _ < v[c]; _++) {
    var d = {};
...
function tc(r, t, e) {
  for (var i = r.width, a = r.height, n = i > a, s = Ef([i, a], n ? 0 : 1, t), o = n ? "width" : "height", f = n ? "height" : "width", h = n ? "x" : "y", u = n ? "y" : "x", v = r[o] / s.length, l = 0; l < s.length; l++) for (var c = r[f] / s[l], p = 0; p < s[l]; p++) {
    var _ = {};
...
function rc(r, t, e, i, a, n, s, o) {
  var f = e - r, h = i - t, u = s - a, v = o - n, l = oo(u, v, f, h);
  if (Math.abs(l) < 1e-6) return null;
  var c = r - a, p = t - n, _ = oo(c, p, u, v) / l;
...
function bi(r, t, e, i) {
  if (e === 1) i.push(t);
    ...
    bi(r, n[0], a, i), bi(r, n[1], e - a, i);
  }
  return i;
}
function ac(r, t) {
  for (var e = [], i = 0; i < t; i++) e.push(of(r));
  return e;
}
function nc(r, t) {
...
function oc(r, t) {
  ...
  switch (r.type) {
    ...
    case "sector":
      ...
      break;
    case "circle":
      so({ r0: 0, r: i.r, startAngle: 0, endAngle: Math.PI * 2, cx: i.cx, cy: i.cy }, t, e), a = Za;
      break;
    default:
      ...
      if (f === 0) bi(fo, { points: o[0] }, t, e);
        ...
        for (var l = t, h = 0; h < f; h++) {
          ...
          p < 0 || (bi(fo, { points: c.poly }, p, e), l -= p);
        }
      }
      a = gn;
      break;
...
function hc(r, t) {
  for (var e, i, a, n = [], s = [], o = 0; o < Math.max(r.length, t.length); o++) {
    ...
    f ? h ? (e = fc(f, h), u = e[0], v = e[1], i = u, a = v) : (v = ho(a || f, f), u = f) : (u = ho(i || h, h), v = h), n.push(u), s.push(v);
  }
  return [n, s];
}
function uo(r) {
...
function Of(r, t) {
  var e = r.getUpdatedPathProxy(), i = t.getUpdatedPathProxy(), a = hc(rn(e), rn(i)), n = a[0], s = a[1], o = r.getComputedTransform(), f = t.getComputedTransform();
  function h() {
    this.transform = null;
  }
  o && vo(n, o), f && vo(s, f), Si(t, "updateTransform", { replace: h }), t.transform = null;
  var u = lc(n, s, 10, Math.PI), v = [];
  Si(t, "buildPath", { replace: function(l) {
...
function kf(r, t, e) {
  ...
  Of(r, t), t.__morphT = 0;
  function n() {
    we(t, "buildPath"), we(t, "updateTransform"), t.__morphT = -1, t.createPathProxy(), t.dirtyShape();
  }
  return t.animateTo({ __morphT: 1 }, Tt({ during: function(s) {
    t.dirtyShape(), a && a(s);
  }, done: function() {
    n(), i && i();
  } }, e)), t;
...
function Vc(r, t, e) {
  ...
  function a(S) {
    for (var b = 0; b < S.length; b++) {
      var T = S[b];
      an(T) ? a(T.childrenRef()) : T instanceof K && i.push(T);
    }
  }
  a(r);
  var n = i.length;
  if (!n) return nn();
  var s = e.dividePath || Bf, o = s({ path: t, count: n });
  if (o.length !== n) return console.error("Invalid morphing: unmatched splitted path"), nn();
  i = Ci(i), o = Ci(o);
  for (var f = e.done, h = e.during, u = e.individualDelay, v = new dn(), l = 0; l < n; l++) {
    var c = i[l], p = o[l];
    p.parent = t, p.copyTransform(v), u || Of(c, p);
  }
  ...
  Si(t, "addSelfToZr", { after: function(S) {
    _(S);
  } }), Si(t, "removeSelfFromZr", { after: function(S) {
    for (var b = 0; b < o.length; b++) o[b].removeSelfFromZr(S);
  } });
  function d() {
    t.__isCombineMorphing = false, t.__morphT = -1, t.childrenRef = null, we(t, "addSelfToZr"), we(t, "removeSelfFromZr");
  }
  var g = o.length;
  if (u) for (var y = g, m = function() {
    y--, y === 0 && (d(), f && f());
  }, l = 0; l < g; l++) {
    var w = u ? Tt({ delay: (e.delay || 0) + u(l, g, i[l], o[l]), done: m }, e) : e;
    kf(i[l], o[l], w);
  }
  else t.__morphT = 0, t.animateTo({ __morphT: 1 }, Tt({ during: function(S) {
    for (var b = 0; b < g; b++) {
      var T = o[b];
    ...
    d();
    for (var S = 0; S < r.length; S++) we(r[S], "updateTransform");
    f && f();
  } }, e));
  return t.__zr && _(t.__zr), { fromIndividuals: i, toIndividuals: o, count: g };
}
function Zc(r, t, e) {
  var i = t.length, a = [], n = e.dividePath || Bf;
  function s(c) {
    for (var p = 0; p < c.length; p++) {
      var _ = c[p];
      an(_) ? s(_.childrenRef()) : _ instanceof K && a.push(_);
    }
  }
  if (an(r)) {
    s(r.childrenRef());
    var o = a.length;
    if (o < i) for (var f = 0, h = o; h < i; h++) a.push(of(a[f++ % o]));
    a.length = i;
  } else {
    a = n({ path: r, count: i });
    for (var u = r.getComputedTransform(), h = 0; h < a.length; h++) a[h].setLocalTransform(u);
    if (a.length !== i) return console.error("Invalid morphing: unmatched splitted path"), nn();
  }
  a = Ci(a), t = Ci(t);
  for (var v = e.individualDelay, h = 0; h < i; h++) {
    var l = v ? Tt({ delay: (e.delay || 0) + v(h, i, a[h], t[h]) }, e) : e;
    kf(a[h], t[h], l);
  }
