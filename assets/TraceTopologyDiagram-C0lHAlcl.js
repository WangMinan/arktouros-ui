import { a as _ } from "./index-BArkD3X4.js";
import { b as $ } from "./@vueuse-Dwh3V-Wi.js";
import { t as m } from "./dateUtil-BAIp0Nbc.js";
import { i as b } from "./echarts-CFTPmQCF.js";
import { _ as h } from "./index-CR7So4Ot.js";
import { r as P, af as k, w, b as x, W as z, c as D, o as B } from "./@vue-ggRZ67L8.js";
const N = { id: "trace-topology-div" }, C = { __name: "TraceTopologyDiagram", props: { serviceName: Array }, setup(u, { expose: f }) {
  ...
  f({ getTopology: y, disposeSpanTopology: c });
  let a;
  x(() => {
  ...
  const d = () => {
    ...
    t = b(document.getElementById("trace-topology-div"), i.value === "dark" ? "dark" : "light"), t.setOption(o);
  };
  return (o, e) => (B(), D("div", N));
} }, U = h(C, [["__scopeId", "data-v-652c6253"]]);
export {
  U as T
};
